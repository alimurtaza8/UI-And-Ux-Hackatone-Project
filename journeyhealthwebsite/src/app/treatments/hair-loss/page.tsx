        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 mb-8 md:mb-0 pr-0 md:pr-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-[#1e372f] leading-tight mb-6">
              Focus on proven care for hair loss
            </h1>
            
            <p className="text-lg md:text-xl text-[#1e372f] mb-8">
            
            Finasteride helps slow hair loss and support regrowth for men seeking a proven solution
            ...
            <div className="mt-10 space-y-4">
              ...
              <div className="flex items-start">
                ...
                Reduce hair thinning over time
            ...
            <div className="p-8 md:p-12 flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 mb-8 md:mb-0">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
                  ...
                  <br />
                  <span className="text-[#b9d765]">Hair Loss</span>
                </h2>
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'Do I need to keep taking finasteride?',
     answer: 'Yes. Stopping treatment may lead to a return of hair loss.'
   },
   {
     id: 2,
     question: 'Who can use finasteride?',
     answer: 'It is prescribed for men with male pattern hair loss Women generally should not use it.'
   },

  {
    id: 3,
    question: 'How should I take finasteride?',
    answer: 'Follow the instructions provided by your prescriber It is usually taken once daily.'
  },
  {
    id: 4,
    question: 'What is finasteride?',
    answer: 'Finasteride is a medication that can slow hair loss by blocking certain hormone effects.'
  },
  {
    id: 5,
    question: 'Are there any side effects?',
    answer: 'Some may experience mild effects but most people tolerate finasteride well Speak to a healthcare professional if concerned.'
  },
  {
    id: 6,
    question: 'How long before I see results?',
    answer: 'It may take a few months to notice changes but many people see gradual improvement.'
  },
