      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 mb-8 md:mb-0 pr-0 md:pr-8">
            ...
            Scientifically backed methods to ensure you achieve lasting results.
            ...
            <div className="mt-10 space-y-4">
              ...
              <div className="flex items-start">
                ...
                Achieve and maintain erections more reliably
              ...
              <div className="flex items-start">
                ...
                <p className="text-lg text-[#1e372f] font-medium">
                Alleviate the psychological burden associated with ED
...
//                       <div key={variantIndex} className="flex justify-between items-center py-3 border-b border-gray-200 last:border-b-0">
//                         <div>
//                           {product.name} (Pack of {variant.quantity})
//                         </div>
//                         <div className="flex items-center gap-4">
//                           <span className="font-medium text-green-700">{variant.price}</span>
//                           <Link href={variant.link} className="bg-teal-600 hover:bg-teal-700 text-white px-4 py-1 rounded-md text-sm transition-colors">
//                             Select
//                           </Link>
//                         </div>
//                       </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          {products.map((product, index) => (
            <div key={index} className="border border-gray-200 rounded-lg overflow-hidden">
              ...
              {product.variants.map((variant, variantIndex) => (
                <Link href={variant.link} key={variantIndex}>
                  <div className={`flex justify-between items-center px-6 py-4 hover:bg-gray-50 ${
                    variantIndex !== product.variants.length - 1 ? 'border-b border-gray-200' : ''
                  }`}>
            ...
            <div className="p-8 md:p-12 flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 mb-8 md:mb-0">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
                  ...
                  <br />
                  <span className="text-[#b9d765]">Erectile Dysfunction</span>
                </h2>
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'How long does it take to see results from ED treatment?',
     answer: 'The time it takes to see results from ED treatment varies depending on the type of treatment. Oral medications typically work within 30 minutes to an hour and can provide results for several hours. Therapy may take several weeks or months to see improvements, especially when addressing psychological factors.'
   },
   {
     id: 2,
     question: 'What is erectile dysfunction (ED)?',
     answer: 'Erectile dysfunction is the inability to achieve or maintain an erection sufficient for satisfactory sexual performance. It can affect men of all ages but is more common as men get older. ED can result from a variety of physical and psychological factors, including cardiovascular disease, diabetes, stress, anxiety, and hormonal imbalances.'
   },

  {
    id: 3,
    question: 'Are ED treatments safe?',
    answer: 'Yes, most ED treatments are safe when prescribed and supervised by a qualified healthcare professional. It is essential to discuss your medical history and any current medications with your doctor to avoid potential interactions and side effects.'
  },
  {
    id: 4,
    question: 'What are the common causes of erectile dysfunction?',
    answer: 'ED can be caused by several factors. Physical causes include heart disease, high blood pressure, diabetes, obesity, hormonal imbalances, and neurological disorders. Psychological factors such as stress, anxiety, depression, relationship issues, and performance anxiety also contribute to ED. Additionally, lifestyle factors like smoking, excessive alcohol consumption, lack of physical activity, and poor diet can play a role. Certain medications for conditions like high blood pressure and depression may also contribute to erectile dysfunction.'
  },
  {
    id: 5,
    question: 'What treatment options are available for ED?',
    answer: 'There are various treatment options available for erectile dysfunction. Oral medications such as PDE5 inhibitors like Viagra (sildenafil), Cialis (tadalafil), and Levitra (vardenafil) are commonly prescribed. Therapy, including counseling or sex therapy, can be effective for addressing psychological causes. Lifestyle changes, such as improving diet, exercising regularly, quitting smoking, and reducing alcohol intake, can also help.'
  },
