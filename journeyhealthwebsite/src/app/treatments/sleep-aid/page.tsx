        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 mb-8 md:mb-0 pr-0 md:pr-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-[#1e372f] leading-tight mb-6">
              Drift into restful nights with treatment for better sleep
            </h1>
            
            <p className="text-lg md:text-xl text-[#1e372f] mb-8">
            
Wake up revitalised with safe nytol solutions for restful sleep
            ...
            <div className="mt-10 space-y-4">
              ...
              <div className="flex items-start">
                ...
                <p className="text-lg text-[#1e372f] font-medium">
                Minimises nighttime awakenings
            ...
            <div className="p-8 md:p-12 flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 mb-8 md:mb-0">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
                  ...
                  <br />
                  <span className="text-[#b9d765]">Sleep Aid</span>
                </h2>
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'Is nytol suitable for everyone',
     answer: 'While it is widely used, some conditions or medications may conflict with nytol. Always check with a healthcare professional first.'
   },
   {
     id: 2,
     question: 'Will I feel groggy the next day',
     answer: 'Some people report mild grogginess. This can be minimised by taking the recommended dose and allowing enough time for sleep.'
   },

  {
    id: 3,
    question: 'What is nytol and how does it work',
    answer: 'Nytol is an over the counter sleep aid containing a sedating ingredient that helps you relax and fall asleep more easily.'
  },
  {
    id: 4,
    question: 'How quickly does nytol take effect',
    answer: 'Many people feel drowsy within 20 to 30 minutes, though individual responses can vary.'
  },
  {
    id: 5,
    question: 'When should I consider professional help',
    answer: 'If sleep issues persist for more than a few weeks or affect your daily life, consult a specialist for tailored advice.'
  },
  {
    id: 6,
    question: 'Can I use nytol regularly',
    answer: 'Nytol is intended for short term use to address occasional sleeplessness. Seek professional advice for ongoing sleep difficulties.'
  },
...

  {
    ...
    answer: 'Possible side effects include drowsiness, dry mouth, and blurred vision. Speak to your clinician if you experience any concerns.'
  },
