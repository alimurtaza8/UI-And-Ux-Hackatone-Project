        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 mb-8 md:mb-0 pr-0 md:pr-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-[#1e372f] leading-tight mb-6">
              Conquer migraines with fast-acting sumatripatan
            </h1>
            
            <p className="text-lg md:text-xl text-[#1e372f] mb-8">
            
            Experience rapid relief and reclaim your day with targeted migraine treatment.
            ...
            <div className="mt-10 space-y-4">
              ...
              <div className="flex items-start">
                ...
                Quick headache relief for improved daily functioning
              ...
              <div className="flex items-start">
                ...
                Reduced migraine intensity and frequency
              ...
              <div className="flex items-start">
                ...
                <p className="text-lg text-[#1e372f] font-medium">
                Personalised care for better long-term outcomes
            ...
            <div className="p-8 md:p-12 flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 mb-8 md:mb-0">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
                  ...
                  <br />
                  <span className="text-[#b9d765]">Migraine Relief</span>
                </h2>
 ...
 const faqItems = [
   {
     ...
     answer: 'Common side effects include mild dizziness, tingling, or flushing. Serious side effects are rare but should be discussed with your healthcare provider.'
   },
   {
     id: 2,
     question: 'Can I take sumatriptan for every migraine?',
     answer: 'You can use sumatriptan for acute migraine attacks, but always follow the recommended dosage and frequency to avoid overuse.'
   },

  {
    id: 3,
    question: 'How fast does sumatriptan start working?',
    answer: 'Many patients notice relief within 30 minutes, though individual response times may vary.'
  },
  {
    id: 4,
    question: 'Who is a good candidate for sumatriptan therapy?',
    answer: 'Most adults who experience moderate to severe migraines, especially those not relieved by over-the-counter medications, can benefit from sumatriptan. A full evaluation ensures it’s safe for you.'
  },
  {
    id: 5,
    question: 'Does sumatriptan work for tension headaches or cluster headaches?',
    answer: 'Sumatriptan is specifically indicated for migraines and cluster headaches. It’s less effective for tension-type headaches.'
  },
  {
    id: 6,
    question: 'When should I seek professional help?',
    answer: 'If migraines worsen, become more frequent, or interfere with daily activities, consult a healthcare professional for an effective treatment plan.'
  },
  

  {
    id: 7,
    question: 'What is sumatriptan, and how does it work?',
    answer: 'Sumatriptan belongs to a class of drugs known as triptans. It alleviates migraine pain by constricting dilated blood vessels around the brain and reducing inflammation.'
  },
...
export default function MigraineRelief() {
    return (
        <div>
            <HeroSection />
            <BestSellersSection />
