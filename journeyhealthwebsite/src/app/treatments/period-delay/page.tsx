        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 mb-8 md:mb-0 pr-0 md:pr-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-[#1e372f] leading-tight mb-6">
              Manage your cycle easy with norethisterone help
            </h1>
            
            <p className="text-lg md:text-xl text-[#1e372f] mb-8">
            
            Delay your period safely and enjoy more convenience with norethisterone
            ...
            <div className="mt-10 space-y-4">
              ...
              <div className="flex items-start">
                ...
                Flexible timing for important events
              ...
              <div className="flex items-start">
                ...
                <p className="text-lg text-[#1e372f] font-medium">
                Safe short term period management
            ...
            <div className="p-8 md:p-12 flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 mb-8 md:mb-0">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
                  ...
                  <br />
                  <span className="text-[#b9d765]">Period Delay</span>
                </h2>
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'Will it affect future fertility or cycles',
     answer: 'Occasional use of norethisterone typically does not affect long term fertility or menstrual regularity'
   },
   {
     id: 2,
     question: 'Are there any side effects',
     answer: 'Possible side effects include bloating mood changes or mild spotting. Consult your clinician if these persist.'
   },

  {
    id: 3,
    question: 'How long can I safely delay my period',
    answer: 'Norethisterone is often used for short term delay up to 17 days under clinical guidance.'
  },
  {
    id: 4,
    question: 'Is period delay safe for everyone',
    answer: 'While generally well tolerated your medical history might affect suitability. Seek professional advice to ensure it is appropriate.'
  },
  {
    id: 5,
    question: 'When should I start taking norethisterone',
    answer: 'Usually you begin taking it around three days before your expected period. Your clinician will confirm the exact timing.'
  },
  {
    id: 6,
    question: 'What is norethisterone and how does it work',
    answer: 'Norethisterone is a synthetic hormone that postpones your period by preventing the womb lining from shedding.'
  },
  

  {
    id: 7,
    question: 'What if my period is irregular',
    answer: 'Speak with a clinician who can tailor a plan to align norethisterone use with your unique cycle.'
  },
...
export default function PeriodDelay() {
    return (
        <div>
            <HeroSection />
            <BestSellersSection />
