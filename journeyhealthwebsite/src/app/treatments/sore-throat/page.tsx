        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 mb-8 md:mb-0 pr-0 md:pr-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-[#1e372f] leading-tight mb-6">
              Banish strep throat now with expert antibiotic care today
            </h1>
            
            <p className="text-lg md:text-xl text-[#1e372f] mb-8">
            Target infection fast reduce sore throat and discover quick relief with trusted antibiotic solutions
            ...
            <div className="mt-10 space-y-4">
              ...
              <div className="flex items-start">
                ...
                <p className="text-lg text-[#1e372f] font-medium">
                Effective bacterial eradication for a quicker recovery
            ...
            <div className="p-8 md:p-12 flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 mb-8 md:mb-0">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
                  ...
                  <br />
                  <span className="text-[#b9d765]">Sore Throat</span>
                </h2>
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'Who is suitable for phenoxymethylpenicillin or clarithromycin',
     answer: 'Your clinician will assess your medical history allergies and current health to recommend the most appropriate antibiotic.'
   },
   {
     id: 2,
     question: 'Can I stop antibiotics once I feel better',
     answer: 'No. Always finish your full course to ensure the infection is fully cleared and to reduce the risk of resistance.'
   },

  {
    id: 3,
    question: 'What if my sore throat does not improve',
    answer: 'Book a follow up appointment to check if a different treatment or further investigation is needed.'
  },
  {
    id: 4,
    question: 'How do phenoxymethylpenicillin and clarithromycin help',
    answer: 'Both medications target the bacteria responsible for strep throat reducing symptoms and preventing further spread.'
  },
  {
    id: 5,
    question: 'Are there any side effects',
    answer: 'Possible side effects include stomach upset diarrhoea or a skin rash. Contact your clinic if you notice any serious reactions.'
  },
  {
    id: 6,
    question: 'What is strep throat and how is it caused',
    answer: 'Strep throat is a bacterial infection usually caused by group A Streptococcus which leads to soreness and irritation in the throat.'
  },
...

  {
    ...
    answer: 'A typical course lasts around 7 to 10 days. It is crucial to complete all prescribed doses.'
  },
