        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 mb-8 md:mb-0 pr-0 md:pr-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-[#1e372f] leading-tight mb-6">
              Increase your pleasure and regain intimate control today
            </h1>
            
            <p className="text-lg md:text-xl text-[#1e372f] mb-8">
            
            Overcome premature ejaculation with proven therapies for improved control confidence and sexual satisfaction
            ...
            <div className="p-8 md:p-12 flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 mb-8 md:mb-0">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
                  ...
                  <br />
                  <span className="text-[#b9d765]">Premature Ejaculation</span>
                </h2>
 ...
 const faqItems = [
   {
     ...
     answer: 'It can result from psychological factors physical issues or a combination of both. Stress anxiety and certain health conditions may contribute.'
   },
   {
     id: 2,
     question: 'Are there any side effects',
     answer: 'Possible side effects include headache mild nausea or skin irritation. Speak with a professional if they persist.'
   },

  {
    id: 3,
    question: 'Is it safe to combine priligy with stud 100',
    answer: 'Many men use both without issues but consult a clinician for personalised advice and dosage guidelines.'
  },
  {
    id: 4,
    question: 'How can priligy help',
    answer: 'Priligy is designed to increase the time before ejaculation by influencing neurotransmitters in the brain.'
  },
  {
    id: 5,
    question: 'What if treatment does not work',
    answer: 'If results are unsatisfactory a clinician can explore alternative therapies or adjust your treatment plan.'
  },
  {
    id: 6,
    question: 'When should I expect to see results',
    answer: 'Some notice an immediate improvement. Others may need a few tries to find the best timing and dosage.'
  },
  

  {
    id: 7,
    question: 'What is stud 100 spray',
    answer: 'Stud 100 spray contains a mild local anaesthetic that reduces sensitivity helping delay climax.'
  },
