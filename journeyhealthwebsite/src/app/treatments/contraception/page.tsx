        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 mb-8 md:mb-0 pr-0 md:pr-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-[#1e372f] leading-tight mb-6">
              Empower your life with reliable contraception guidance
            </h1>
            
            <p className="text-lg md:text-xl text-[#1e372f] mb-8">
            
            Explore safe effective options for a confident approach to contraception and better peace of mind
            ...
            <div className="mt-10 space-y-4">
              ...
              <div className="flex items-start">
                ...
                Flexible birth control tailored to your lifestyle
              ...
              <div className="flex items-start">
                ...
                <p className="text-lg text-[#1e372f] font-medium">
                Improved menstrual cycle control and symptom relief
            ...
            <div className="p-8 md:p-12 flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 mb-8 md:mb-0">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
                  ...
                  <br />
                  <span className="text-[#b9d765]">Contraception</span>
                </h2>
 ...
 const faqItems = [
   {
     ...
     answer: 'If you are considering starting or changing contraception seeking professional advice ensures you make an informed decision.'
   },
   {
     id: 2,
     question: 'What types of contraception are available at Journey Health',
     answer: 'We offer a range of contraceptive methods including combined and progestogen only pills as well as long acting reversible options.'
   },

  {
    id: 3,
    question: 'Are there possible side effects',
    answer: 'Certain methods can cause changes in mood weight or menstrual patterns. We will discuss all potential side effects with you.'
  },
  {
    id: 4,
    question: 'How effective is the pill',
    answer: 'When taken correctly the pill is highly effective. However individual factors like missed doses can reduce its efficacy.'
  },
  {
    id: 5,
    question: 'Can I switch contraception methods if needed',
    answer: 'Yes. Your needs may change over time so we can help you transition to a more suitable option.'
  },

  {
    id: 6,
    question: 'Which contraception method is best for me',
    answer: 'Our clinician will review your health history discuss your goals and recommend the most suitable option'
  },
