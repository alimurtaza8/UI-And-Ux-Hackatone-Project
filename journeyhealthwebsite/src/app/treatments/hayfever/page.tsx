        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 mb-8 md:mb-0 pr-0 md:pr-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-[#1e372f] leading-tight mb-6">
              Breath easy again with hayfever treatment
            </h1>
            
            <p className="text-lg md:text-xl text-[#1e372f] mb-8">
            
            Effective solutions to ease your hayfever and help you reclaim a symptom-free lifestyle.
            ...
            <div className="mt-10 space-y-4">
              ...
              <div className="flex items-start">
                ...
                Individualised treatment plans tailored to you
            ...
            <div className="p-8 md:p-12 flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 mb-8 md:mb-0">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
                  ...
                  <br />
                  <span className="text-[#b9d765]">Hayfever</span>
                </h2>
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'Do I need prescription medication for hayfever?',
     answer: 'Not always. Many patients benefit from over-the-counter remedies, but prescription options may be necessary for severe cases.'
   },
   {
     id: 2,
     question: 'What causes hayfever symptoms?',
     answer: 'Hayfever (allergic rhinitis) occurs when your immune system reacts to airborne allergens like pollen.'
   },

  {
    id: 3,
    question: 'How long does it take to see improvements?',
    answer: 'Most patients notice relief within days, but consistent symptom control may require ongoing management.'
  },
  {
    id: 4,
    question: 'How do I know if I have hayfever or a cold?',
    answer: 'Hayfever typically features itching, sneezing, and clear nasal discharge, while a cold often includes thicker mucus and general malaise.'
  },
  {
    id: 5,
    question: 'Can lifestyle changes help manage hayfever?',
    answer: 'Absolutely. Strategies like avoiding high-pollen areas, keeping windows closed, and using air purifiers can significantly reduce symptoms.'
  },
  {
    id: 6,
    question: 'When should I seek professional help for hayfever?',
    answer: 'If your symptoms are persistent, disruptive, or not controlled by basic measures, it’s time to consult a specialist.'
  },
  

  {
    id: 7,
    question: 'Are hayfever treatments safe and effective?',
    answer: 'Yes. We offer evidence-based solutions, including medications and lifestyle strategies proven to reduce symptoms.'
  },
