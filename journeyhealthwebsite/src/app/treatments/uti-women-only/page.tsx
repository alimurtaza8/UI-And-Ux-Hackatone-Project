        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 mb-8 md:mb-0 pr-0 md:pr-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-[#1e372f] leading-tight mb-6">
              Soothe painful UTI with clinically proven nitrofurantoin relief now
            </h1>
            
            <p className="text-lg md:text-xl text-[#1e372f] mb-8">
            Clear your symptoms fast and reclaim comfort with safe nitrofurantoin solutions for women&apos;s urinary health
            ...
            <div className="mt-10 space-y-4">
              ...
              <div className="flex items-start">
                ...
                Rapid relief from painful UTI symptoms
              ...
              <div className="flex items-start">
                ...
                <p className="text-lg text-[#1e372f] font-medium">
                Targeted antibiotic therapy with fewer side effects
            ...
            <div className="p-8 md:p-12 flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 mb-8 md:mb-0">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
                  ...
                  <br />
                  <span className="text-[#b9d765]">UTI Women Only</span>
                </h2>
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'How does nitrofurantoin work',
     answer: 'Nitrofurantoin targets and kills the bacteria responsible for UTIs. It is specifically formulated to be highly effective in the urinary tract.'
   },
   {
     id: 2,
     question: 'What causes urinary tract infections in women',
     answer: 'UTIs often occur when bacteria enter the urethra and multiply in the bladder. Sexual activity and certain anatomical factors can increase the risk.'
   },

  {
    id: 3,
    question: 'Is nitrofurantoin safe for all women',
    answer: 'It is generally safe but may not be suitable for those with certain kidney issues or allergies. Always consult a clinician before use.'
  },
  {
    id: 4,
    question: 'Will nitrofurantoin prevent future UTIs',
    answer: 'While it treats the current infection it does not guarantee protection from future UTIs. Lifestyle habits and regular check ups can help reduce the risk.'
  },
  {
    id: 5,
    question: 'Can I take nitrofurantoin while pregnant',
    answer: 'While it treats the current infection it does not guarantee protection from future UTIs. Lifestyle habits and regular check ups can help reduce the risk.'
  },
  {
    id: 6,
    question: 'What if my symptoms persist',
    answer: 'If symptoms do not improve or worsen seek further medical advice to rule out complications or the need for alternative treatments.'
  },
...

  {
    ...
    answer: 'Many women feel relief within a few days. It is vital to complete the full course of antibiotics to ensure the infection is cleared.'
  },
...
export default function UtilWomenOnly() {
    return (
        <div>
            <HeroSection />
            <BestSellersSection />
