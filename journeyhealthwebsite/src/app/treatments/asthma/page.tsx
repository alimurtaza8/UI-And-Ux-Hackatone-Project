        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 mb-8 md:mb-0 pr-0 md:pr-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-[#1e372f] leading-tight mb-6">
             Breathe easier every day with salbutamol for asthma
            </h1>
            
            <p className="text-lg md:text-xl text-[#1e372f] mb-8">
            
            Get rapid relief from asthma symptoms and reclaim your active life with proven salbutamol treatment
            ...
            <div className="mt-10 space-y-4">
              ...
              <div className="flex items-start">
                ...
                Quick rescue from breathing difficulties
            ...
            <div className="p-8 md:p-12 flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 mb-8 md:mb-0">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
                  ...
                  <br />
                  <span className="text-[#b9d765]">Asthma</span>
                </h2>
 ...
 const faqItems = [
   {
     ...
     answer: 'Some people may experience tremors or a rapid heartbeat. These usually subside once your body adjusts. Speak to a clinician if they persist.'
   },
   {
     id: 2,
     question: 'How often can I use salbutamol',
     answer: 'You can use it as directed by your clinician. Frequent or increased use may signal that your asthma is not well controlled.'
   },

  {
    id: 3,
    question: 'Do I need other asthma treatments',
    answer: 'Some patients require additional medication such as steroid inhalers to keep inflammation under control. Your clinician will guide you.'
  },
  {
    id: 4,
    question: 'How quickly will I feel relief',
    answer: 'Many people experience noticeable relief within minutes of using a salbutamol inhaler.'
  },
  {
    id: 5,
    question: 'When should I see a professional for asthma',
    answer: 'If you are using your inhaler more than recommended or if symptoms worsen book a check up as soon as possible.'
  },

  {
    id: 6,
    question: 'What is salbutamol and how does it work',
    answer: 'Salbutamol is a bronchodilator that relaxes the muscles in your airways allowing easier breathing and fast symptom relief.'
  },

  {
    id: 7,
    question: 'Is salbutamol safe for children',
    answer: 'Yes when prescribed by a healthcare professional it can be used safely in children with correct dosage and monitoring.'
  },
