        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 mb-8 md:mb-0 pr-0 md:pr-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-[#1e372f] leading-tight mb-6">
              Relieve heartburn and indigestion now with trusted omeprazole support 
            </h1>
            
            <p className="text-lg md:text-xl text-[#1e372f] mb-8">
            Soothe digestive discomfort reduce acid reflux and regain a balanced stomach with professional omeprazole support


            </p>
            
            <button className="bg-[#f29a88] hover:bg-[#e88b79] text-black font-medium py-3 px-8 rounded-full transition duration-300">
            Ready for lasting stomach relief?
            </button>
            ...
            <div className="mt-10 space-y-4">
              ...
              <div className="flex items-start">
                ...
                Minimises heartburn and acid reflux
              ...
              <div className="flex items-start">
                ...
                <p className="text-lg text-[#1e372f] font-medium">
                Helps you enjoy meals without discomfort
            ...
            <div className="p-8 md:p-12 flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 mb-8 md:mb-0">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
                  ...
                  <br />
                  <span className="text-[#b9d765]">Stomach and Digestion</span>
                </h2>
 ...
 const faqItems = [
   {
     ...
     answer: 'Side effects can include headache nausea or dizziness. If symptoms persist or worsen consult your clinician.'
   },
   {
     id: 2,
     question: 'When should I consult a professional for stomach issues',
     answer: 'If stomach pain reflux or indigestion is severe or persistent seek medical attention to determine the best treatment.'
   },

  {
    id: 3,
    question: 'Is omeprazole safe for long term use',
    answer: 'It is generally well tolerated. However long term use should be guided by a clinician to avoid potential complications.'
  },
  {
    id: 4,
    question: 'Who can benefit from omeprazole',
    answer: 'Anyone experiencing regular heartburn acid reflux or stomach ulcers may find relief with omeprazole. It is important to check with a healthcare provider first.'
  },
  {
    id: 5,
    question: 'Can I take omeprazole with other medications',
    answer: 'Some medications and supplements may interact with omeprazole. Always discuss your current prescriptions with a healthcare professional.'
  },
  {
    id: 6,
    question: 'What is omeprazole and how does it help me',
    answer: 'Omeprazole is a proton pump inhibitor that lowers stomach acid levels helping to ease reflux and indigestion.'
  },
...

  {
    ...
    answer: 'Many people feel better within a few days but it can take up to two weeks for full benefits.'
  },
...
export default function StomachAndDigestion() {
    return (
        <div>
            <HeroSection />
            <BestSellersSection />
