        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 mb-8 md:mb-0 pr-0 md:pr-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-[#1e372f] leading-tight mb-6">
              Conquer jet lab naturally with melatonin support
            </h1>
            
            <p className="text-lg md:text-xl text-[#1e372f] mb-8">
            
            Recalibrate your body clock, reduce fatigue, and embrace refreshed travel routines.
            ...
            <div className="mt-10 space-y-4">
              ...
              <div className="flex items-start">
                ...
                <p className="text-lg text-[#1e372f] font-medium">
                Personalised guidance for effective, safe melatonin use
            ...
            <div className="p-8 md:p-12 flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 mb-8 md:mb-0">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
                  ...
                  <br />
                  <span className="text-[#b9d765]">Jet Lag</span>
                </h2>
 ...
 const faqItems = [
   {
     ...
     answer: 'Jet lag happens when your internal clock struggles to adjust to a new time zone, leading to sleep disturbances and fatigue.'
   },
   {
     id: 2,
     question: 'How long does melatonin take to work?',
     answer: 'Many people notice improvements within a few days. Consistent use and proper timing are crucial for best results.'
   },

  {
    id: 3,
    question: 'Is melatonin safe for everyone?',
    answer: 'While generally well-tolerated, it’s essential to consult a healthcare professional to ensure it’s appropriate for your specific health needs.'
  },
  {
    id: 4,
    question: 'Can I combine melatonin with other sleep aids?',
    answer: 'It depends on the medication. Always consult a healthcare provider for personalised recommendations.'
  },
  {
    id: 5,
    question: 'When should I take melatonin for jet lag?',
    answer: 'Timing varies based on travel direction and personal factors. Our specialists tailor advice to optimize your dosage schedule.'
  },
  {
    id: 6,
    question: 'How does melatonin help with jet lag?',
    answer: 'Melatonin, a natural hormone, helps regulate your sleep-wake cycle, making it easier to adapt to new time zones.'
  },
  

  {
    id: 7,
    question: 'When should I seek professional help for jet lag?',
    answer: 'If persistent sleep issues affect your well-being, talk to a medical expert for customised solutions.'
  },
