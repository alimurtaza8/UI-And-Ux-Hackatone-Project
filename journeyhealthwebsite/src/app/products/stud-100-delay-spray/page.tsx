    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          ...
          Stud 100 Spray offers rapid relief from premature ejaculation by enhancing control and confidence for a more satisfying intimate experience.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Stud 100 Spray is a proven treatment that helps men manage premature ejaculation effectively. This clinically recommended solution works quickly to improve control and boost confidence in intimate moments. Developed using advanced formulation, it is safe and easy to use with minimal side effects. The spray offers rapid relief and can be integrated into your routine discreetly. Enjoy longer lasting pleasure and enhanced satisfaction for both you and your partner. Suitable for regular use under professional guidance and ideal for restoring natural performance and confidence.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'How does Stud 100 Spray work?',
     answer: 'Stud 100 Spray is formulated to reduce sensitivity and prolong performance during intimate moments by gently numbing the area and allowing enhanced control.',

   },
   {
    id: 2,
    question: 'Is Stud 100 Spray safe for regular use?',
    answer: 'Yes, when used as directed by a healthcare professional, it is safe for regular use and exhibits minimal side effects.',
  },
  {
   id: 3,
   question: 'How quickly does the spray take effect?',
   answer: 'Most users experience its benefits within minutes of application, allowing spontaneous and satisfying intimacy.',
 },
 {
   id: 4,
   question: 'Can it be used alongside other treatments?',
   answer: 'It is advisable to consult with your clinician if you are using additional medications or therapies to ensure compatibility.',
 },
 {
   id: 5,
   question: 'What is the recommended application procedure?',
   answer: 'Apply a small amount to the intended area a few minutes before intimacy and allow it to absorb fully for optimal results.',
 },
 {
   id: 6,
   question: 'Are there any common side effects?',
   answer: 'The spray is well tolerated by most men, though some may experience mild irritation or temporary numbness which usually subsides quickly.',
 },
