    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          <h2 className="text-3xl font-medium mb-6">Nitrofurantoin 100mg
          ...
          Nitrofurantoin 100mg is a prescription antibiotic that targets bacteria causing urinary tract infections providing rapid relief from symptoms while helping prevent complications.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Nitrofurantoin 100mg is designed specifically to help women overcome urinary tract infections UTI by inhibiting bacterial growth in the bladder and urinary tract. This antibiotic can quickly reduce painful symptoms such as burning when urinating or the constant urge to go. When taken according to your doctor&apos;s instructions it lowers the risk of complications or recurring infections. Ensure you complete the full course even if symptoms subside early to clear the infection fully. It is vital to discuss any medical history or allergies with your healthcare professional before starting Nitrofurantoin 100mg. Seek medical advice if symptoms persist or worsen.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'How does Nitrofurantoin 100mg treat a UTI?',
     answer: 'It works by stopping bacteria from growing in the urinary tract reducing pain and other uncomfortable symptoms.',

   },
   {
    id: 2,
    question: 'How long should I take it?',
    answer: 'Follow the prescribed course usually three to seven days depending on your doctor\'s recommendation. Never stop early without advice.',
  },
  {
   id: 3,
   question: 'What if I am pregnant or breastfeeding?',
   answer: 'Inform your doctor before starting treatment as they can advise on the safest option during pregnancy or while breastfeeding.'
 },
 {
   id: 4,
   question: 'Are there any side effects?',
   answer: 'Possible side effects include nausea headache or changes in urine colour. Speak to a healthcare professional if side effects become concerning.'
 },
 {
   id: 5,
   question: 'Can I drink alcohol while on Nitrofurantoin 100mg?',
   answer: 'It is generally best to avoid alcohol which may worsen side effects or interfere with recovery. Ask your doctor for personalised advice.'
 },
 {
   id: 6,
   question: 'What should I do if I miss a dose?',
   answer: 'Take it as soon as you remember. If it is almost time for your next dose skip the missed one and continue as directed.'
 },
 {
   id: 7,
   question: 'When should I seek further help?',
   answer: 'If your symptoms worsen fail to improve or you develop severe side effects contact your healthcare provider promptly.'
 },
