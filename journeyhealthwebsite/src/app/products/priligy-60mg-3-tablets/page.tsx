    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          <h2 className="text-3xl font-medium mb-6">Priligy 30mg (6 Tablets)
          ...
          Priligy 60mg (3 Tablets) is a clinically approved solution that helps men manage premature ejaculation. Safe, effective and prescribed by health professionals.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Priligy 60mg offers a proven treatment option for men experiencing premature ejaculation. The tablets work by delaying ejaculation, giving you enhanced control during intimacy. Manufactured to the highest standards, this prescription product is recommended by health professionals and provides a safe solution for improving sexual performance and confidence. Each pack contains three tablets designed for on demand use under professional guidance. Experience improved satisfaction and natural intimacy without compromising your well being. Always consult your healthcare provider to ensure Priligy 60mg is the right option for your needs.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Priligy used for?',
     answer: 'Priligy is used to manage premature ejaculation in men by delaying ejaculation and improving control during intimacy.',

   },
   {
    id: 2,
    question: 'How does Priligy work?',
    answer: 'The medication works by moderating nerve signals that trigger ejaculation, allowing for longer lasting intimacy.',
  },
  {
   id: 3,
   question: 'Is Priligy safe?',
   answer: 'Yes, Priligy is a clinically approved product that is prescribed by healthcare professionals after a thorough consultation.',
 },
 {
   id: 4,
   question: 'What is the recommended dosage?',
   answer: 'The typical dosage is 60mg per tablet taken on demand. Your doctor will advise the best regimen for you',
 },
 {
   id: 5,
   question: 'When should I take Priligy?',
   answer: 'It is recommended to take Priligy one hour before anticipated sexual activity for optimal results.',
 },
 {
   id: 6,
   question: 'Are there any side effects?',
   answer: 'Some men may experience mild side effects such as headache or dizziness. Always discuss potential risks with your healthcare provider.',
 },
 {
   id: 7,
   question: 'Do I need a prescription?',
   answer: 'Yes, Priligy is available only with a prescription to ensure it is safe and appropriate for your condition.',
 },
