    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          ...
          Enhance your intimate performance with Tadalafil 10mg (Pack of 4). You benefit from a proven dose that outperforms lower strengths and alternative treatments for erectile dysfunction.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Tadalafil 10mg (Pack of 4) is a trusted prescription treatment designed to improve your erectile function and boost your confidence. This optimised dose offers fast and lasting results compared to lower strengths and other options. You enjoy an effective treatment that supports a more satisfying intimate life. With guidance from our experienced team, you receive personalised advice and regular follow ups to ensure your safety and success. Enhance your performance with a proven solution tailored to your needs.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Tadalafil 10mg (Pack of 4)?',
     answer: 'It is a prescription treatment for erectile dysfunction that provides you with a reliable supply of 4 tablets of Tadalafil 10mg.',

   },
   {
    id: 2,
    question: 'How does Tadalafil 10mg benefit you over lower strengths?',
    answer: 'You benefit from a higher potency and optimised dose that delivers faster and longer lasting results compared to lower strength options.',
  },
  {
   id: 3,
   question: 'How does it compare to other treatment options?',
   answer: 'Its proven efficacy and sustained performance make it a reliable choice over alternative treatments for erectile dysfunction.',
 },
 {
   id: 4,
   question: 'Who is suitable for Tadalafil 10mg?',
   answer: 'Men experiencing erectile dysfunction can benefit from this treatment after a thorough medical evaluation tailored to your needs.',
 },
 {
   id: 5,
 ...
 },
 {
   ...
   answer: 'You receive personalised advice, regular follow ups and lifestyle recommendations designed to optimise your results.',
 },

 {
    id: 7,
    question: 'Can Tadalafil 10mg improve your confidence?',
    answer: 'Yes, by effectively addressing erectile dysfunction, it helps boost your confidence and enhances your intimate life.',
  },
