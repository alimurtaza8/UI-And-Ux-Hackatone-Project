    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          <h2 className="text-3xl font-medium mb-6">Melatonin 3mg

          </h2>
          <p className="text-gray-200 text-lg leading-relaxed">
         
          Melatonin 3mg helps support healthy sleep patterns for those experiencing sleep disturbances or seeking natural circadian rhythm regulation. Achieve restful nights and wake energised.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Melatonin 3mg is carefully formulated to support a regular sleep wake cycle and combat occasional sleeplessness. By regulating your body&apos;s internal clock, this natural hormone can help reduce the time it takes to drift off and improve the quality of your rest. It is often used to support those with jet lag, shift work disturbances or general sleeping difficulties. Our high quality formulation prioritises consistency and purity, so you can feel confident adding it to your bedtime routine. Choose Melatonin 3mg as part of a comprehensive approach to better rest that includes good sleep hygiene and healthy lifestyle choices.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Melatonin 3mg used for?',
     answer: 'It helps regulate the body\'s sleep wake cycle to promote better rest and may be helpful for occasional sleeplessness or conditions like jet lag.',

   },
   {
    id: 2,
    question: 'How does it work?',
    answer: 'Melatonin is a hormone that signals to your body when it is time to sleep. By taking a supplement you can support healthy sleep patterns.'
  },
  {
   id: 3,
   question: 'Is Melatonin 3mg safe?',
   answer: 'It is generally considered safe for short term use but always consult your healthcare provider for personalised advice especially if you have ongoing medical conditions.'
 },
 {
   id: 4,
   question: 'How long should I take Melatonin 3mg?',
   answer: 'Usage may vary depending on individual needs but it is best to follow healthcare guidance or product instructions for safe and effective use'
 },
 {
   id: 5,
   question: 'Can I take it with other medications?',
   answer: 'Some medicines and supplements may interact with melatonin. Consult your doctor to ensure it is appropriate for you.'
 },
 {
   id: 6,
   question: 'When is the best time to take Melatonin 3mg?',
   answer: 'Most people take it 30 minutes to an hour before bedtime for optimal results.'
 },
 {
   id: 7,
   question: 'Are there any side effects?',
   answer: 'Common side effects can include drowsiness or mild headaches. If you experience any unusual reactions speak to a healthcare professional.'
 },
