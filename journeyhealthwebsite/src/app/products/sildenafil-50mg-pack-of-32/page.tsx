    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          ...
          Enhance your performance with Sildenafil 50mg in a pack of 32. You benefit from a large, cost effective supply that delivers superior results compared to alternative treatments and lower strengths.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Sildenafil 50mg (Pack of 32) is a trusted prescription treatment designed to address your erectile dysfunction and boost your sexual performance. With this extensive supply, you benefit from a cost effective and convenient solution that ensures you never run out of your medication. Its optimised dose offers faster and more effective results than lower strengths and other treatment options. Under expert guidance, you receive personalised advice and ongoing support to ensure your treatment is safe and successful. Regain your confidence and enjoy a more satisfying intimate life with this proven treatment.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Sildenafil 50mg (Pack of 32)?',
     answer: 'It is a prescription treatment for erectile dysfunction that provides you with 32 tablets of Sildenafil 50mg for a long term supply.',

   },
   {
    id: 2,
    question: 'How does this pack benefit you over smaller packs?',
    answer: 'You benefit from a larger, cost effective supply that ensures you always have your medication on hand, reducing the need for frequent reorders.',
  },
  {
   id: 3,
   question: 'How does Sildenafil 50mg compare to lower strengths?',
   answer: 'Sildenafil 50mg offers an optimised dose that delivers faster and more effective results than lower strength options, enhancing your performance.',
 },
 {
   id: 4,
   question: 'Why choose this treatment over alternative options?',
   answer: 'Its proven efficacy and optimised dosing make it a reliable choice for managing erectile dysfunction and boosting your sexual confidence.',
 },
 {
   id: 5,
   question: 'How should you take Sildenafil 50mg?',
   answer: 'It is taken orally as directed by your healthcare provider to ensure safe and effective use for your erectile dysfunction.',
 },
 {
   id: 6,
