...
Experience transformative weight loss with Wegovy 2.4mg. Ideal for men and women seeking superior appetite control and enhanced benefits over lower strengths.
...
Wegovy 2.4mg is an advanced prescription treatment designed to support sustainable weight loss for men and women. It works by regulating appetite signals, reducing hunger and enhancing portion control. Offering improved benefits compared to lower strengths, this treatment promotes healthier eating habits and overall wellbeing. Our clinic provides personalised care, regular check ups and ongoing support to ensure safe and effective treatment. Combined with a balanced diet and regular exercise, Wegovy 2.4mg offers a transformative approach to weight management and renewed confidence.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Wegovy 2.4mg?',
     answer: 'Wegovy 2.4mg is a prescription weight management treatment designed to support sustainable weight loss for men and women.',

   },
   {
    id: 2,
    question: 'How does Wegovy 2.4mg differ from lower strengths?',
    answer: 'It offers enhanced appetite control and improved regulation of hunger and portion sizes compared to lower strengths.',
  },
  {
   id: 3,
   question: 'What benefits does Wegovy 2.4mg provide?',
   answer: 'It promotes healthier eating habits, reduces hunger and supports overall wellbeing with a higher dose for greater results.',
 },
 {
   id: 4,
   question: 'Who is eligible for this treatment?',
   answer: 'Men and women facing weight management challenges may benefit from Wegovy 2.4mg following a comprehensive medical evaluation.',
 },
 {
   id: 5,
   question: 'How is Wegovy 2.4mg administered?',
   answer: 'The treatment is given by injection with detailed training provided to ensure safe self administration.',
 },
 {
   id: 6,
   question: 'Is Wegovy 2.4mg safe?',
   answer: 'When used under expert medical guidance, Wegovy 2.4mg is a safe and effective option for weight loss.',
 },

 {
    id: 7,
    question: 'Can lifestyle changes improve its effectiveness?',
    answer: 'Yes, combining Wegovy 2.4mg with a balanced diet and regular exercise can enhance its benefits and support long term weight management.',
  },
