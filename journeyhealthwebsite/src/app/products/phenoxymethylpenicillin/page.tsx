    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          ...
          Phenoxymethylpenicillin is a penicillin based antibiotic that targets strep throat bacteria, reducing infection and inflammation for quicker symptom relief.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Phenoxymethylpenicillin also known as penicillin V is an effective antibiotic widely used to treat strep throat. It works by stopping bacteria from growing, thereby helping reduce inflammation and easing painful symptoms. When taken as prescribed it can shorten recovery time and prevent complications like tonsillitis and ear infections. For best results make sure you follow the full course and maintain good rest and hydration. Discuss any allergies or other medicines with your healthcare professional. If symptoms do not improve within a few days or worsen consult a doctor. Phenoxymethylpenicillin can be a key step toward a healthy recovery from strep throat.
 ...
 const faqItems = [
   {
     ...
     answer: 'It is primarily used to treat strep throat and related bacterial infections that affect the throat and tonsils.',

   },
   {
    id: 2,
    question: 'How quickly does it work?',
    answer: 'Most people notice improvement within a few days but it is important to finish the prescribed course for the best outcome.',
  },
  {
   id: 3,
   question: 'Can I take it if I am allergic to penicillin?',
   answer: 'No if you are allergic to penicillin this medication is not suitable. Inform your doctor about any allergies before starting treatment.',
 },
 {
   id: 4,
   question: 'Are there common side effects?',
   answer: 'Common side effects include mild stomach upset diarrhoea and sometimes skin rash. Seek medical advice if symptoms become severe.',
 },
 {
   id: 5,
   question: 'Do I need to complete the full course?',
   answer: 'Yes completing the entire course ensures all bacteria are eliminated reducing the risk of relapse or antibiotic resistance.',
 },
 {
   id: 6,
   question: 'How should I store it?',
   answer: 'Store it in a cool dry place away from direct sunlight and always keep it out of reach of children.',
 },
 {
   id: 7,
   question: 'What if I miss a dose?',
   answer: 'Take the missed dose as soon as you remember unless it is almost time for your next dose. In that case skip it and continue as usual.',
 },
