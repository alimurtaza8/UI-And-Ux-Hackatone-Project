...
const ProductCheck = () => {
    // Hardcoded product data as shown in the example
    const product = {
        id: 'finasteride',
        title: 'Finasteride',
        price: '£13.00',
    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          <h2 className="text-3xl font-medium mb-6">Finasteride
          </h2>
          <p className="text-gray-200 text-lg leading-relaxed">
         
          Finasteride helps reduce hair loss in men by lowering DHT levels, promoting healthy hair growth, and maintaining confidence. Discover how it can support you.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Finasteride is a prescription medication that addresses male pattern hair loss by reducing DHT, a hormone that shrinks hair follicles. Lower DHT levels help slow hair thinning and may promote regrowth, improving hair density and appearance. This once daily oral treatment suits men seeking a convenient approach to maintaining confidence. Many experience visible results after several months of consistent use. Although it is generally well tolerated, possible side effects include reduced libido or mild discomfort. Regular check ups with a healthcare professional are advised. Finasteride can help preserve hair health and restore self esteem for those challenged by hereditary hair loss.
 ...
 const faqItems = [
   {
     ...
     answer: 'Finasteride lowers levels of DHT, the hormone that causes hair follicle shrinkage. By reducing DHT, it slows hair loss and may encourage new growth.'
   },
   {
    id: 2,
    question: 'Do I need regular check ups?',
    answer: 'Periodic reviews with a professional are advised to monitor progress and address any concerns about side effects or dosage adjustments.'
  },
  {
   id: 3,
   question: 'How long before I see results?',
   answer: 'Many men notice improvements after three to six months of consistent use, but it can take up to a year for full effects. Patience is key.'
 },
 {
   id: 4,
   question: 'Is a prescription required?',
   answer: 'Yes Finasteride is only available through a licensed medical practitioner. Our clinic can guide you through the consultation process.'
 },
 {
   id: 5,
   question: 'Can I combine Finasteride with other hair treatments?',
   answer: 'Yes, some patients use additional therapies like topical minoxidil for enhanced outcomes. Always consult your healthcare provider before starting new treatments.'
 },
 {
   id: 6,
   question: 'What are the possible side effects?',
   answer: 'Some individuals experience reduced libido or mild discomfort. These effects often improve with continued use. Speak to a medical professional if you have any concerns.'
 },
 {
   id: 7,
   question: 'Is Finasteride suitable for all men?',
   answer: 'It is typically prescribed for adult men with male pattern baldness. A healthcare provider can help determine if it is right for your circumstances.'
 },
