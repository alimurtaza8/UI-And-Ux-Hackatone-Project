...
Discover Wegovy 0.25mg for effective weight management. Suitable for men and women seeking a safe, clinically supported solution for weight loss.
...
Wegovy 0.25mg offers a proven approach to weight loss for both men and women. This treatment supports appetite control and healthier eating habits while being administered under medical supervision. Our clinic provides expert guidance and tailored care to help you achieve your weight management goals. Experience a safe and effective journey towards improved wellbeing and confidence with a product trusted by healthcare professionals. Begin your transformation with dedicated support and a comprehensive treatment plan.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Wegovy 0.25mg?',
     answer: 'It is a weight management medication designed to support appetite control and healthier eating habits for both men and women.',

   },
   {
    id: 2,
    question: 'How does Wegovy work?',
    answer: 'Wegovy works by regulating appetite signals, helping to reduce hunger and promote a feeling of fullness',
  },
  {
   id: 3,
   question: 'Is Wegovy safe?',
   answer: 'When used under medical supervision, Wegovy is safe and effective for weight loss in appropriately selected patients.',
 },
 {
   id: 4,
   question: 'Who can benefit from Wegovy?',
   answer: 'Men and women struggling with weight management may benefit from this treatment, especially when combined with lifestyle changes.',
 },
 {
   id: 5,
   question: 'How is the treatment administered?',
   answer: 'Wegovy is given by injection with a simple self-administration process following thorough training by our clinic.',
 },
 {
   id: 6,
   question: 'What support is available during treatment?',
   answer: 'Our clinic offers comprehensive guidance, regular check-ups and personalised advice throughout your weight loss journey.',
 },

 {
    id: 7,
    question: 'Are there any lifestyle recommendations?',
    answer: 'A balanced diet and regular exercise are encouraged to enhance the effectiveness of Wegovy in achieving long-term results',
  },
