    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          <h2 className="text-3xl font-medium mb-6">Priligy 60mg (6 Tablets)
          ...
          Priligy 60mg (6 Tablets) is a trusted treatment that assists men in managing premature ejaculation, promoting improved control and intimacy with a prescription-based solution.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Priligy 60mg offers a proven treatment for men facing premature ejaculation. These tablets help delay ejaculation and improve control during intimacy. Manufactured to high standards, this prescription product is recommended by healthcare professionals for on demand use. Each pack contains six tablets to support a more satisfying and confident sexual experience. Always consult your healthcare provider to ensure Priligy 60mg meets your specific needs.
 ...
 const faqItems = [
   {
     ...
     answer: 'Priligy is designed to manage premature ejaculation by delaying ejaculation and improving control during intimacy.',

   },
   {
    id: 2,
    question: 'How does Priligy work?',
    answer: 'The tablets work by modulating nerve signals responsible for triggering ejaculation which allows for longer lasting intimacy.',
  },
  {
   id: 3,
   question: 'Is Priligy safe?',
   answer: 'Yes, Priligy is a clinically approved product prescribed by healthcare professionals after careful evaluation.',
 },
 {
   id: 4,
   question: 'What is the recommended dosage?',
   answer: 'The typical dosage is 60mg per tablet taken on demand. Your doctor will advise the appropriate regimen for you.',
 },
 {
   id: 5,
   question: 'When should I take Priligy?',
   answer: 'It is advised to take Priligy one hour before anticipated sexual activity for the best results.',
 },
 {
   id: 6,
   question: 'Are there any side effects?',
   answer: 'Some men may experience mild side effects such as headache or dizziness. Please discuss any concerns with your healthcare provider.',
 },
 {
   id: 7,
   question: 'Do I need a prescription?',
   answer: 'Yes, Priligy is available only with a prescription to ensure it is safe and suitable for your condition',
 },
