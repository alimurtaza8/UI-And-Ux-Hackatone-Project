    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          ...
          Salamol inhaler Salbutamol is a fast acting bronchodilator providing quick relief from asthma symptoms by relaxing airways and promoting easier breathing.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Salamol inhaler also known as Salbutamol helps to widen the airways in your lungs relieving breathlessness and wheezing. By quickly relaxing the muscle walls of the airways it eases symptoms of asthma and chronic obstructive pulmonary disease. Salamol can be used as needed to manage sudden attacks or regularly to prevent breathing difficulties. Always use it as directed by your healthcare provider. Remember to keep track of inhaler usage and discuss any concerns such as side effects or reduced effectiveness with a professional.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'How does Salamol inhaler work?',
     answer: 'It relaxes the muscles in the airways making it easier to breathe and providing quick relief from wheezing or tightness.',

   },
   {
    id: 2,
    question: 'How often can I use it?',
    answer: 'Your doctor will advise on frequency. Some people use it only when symptoms occur while others may use it more regularly.',
  },
  {
   id: 3,
   question: 'Are there any side effects?',
   answer: 'Possible side effects include a slightly faster heartbeat shaking or headache. Inform your healthcare professional if these persist.',
 },
 {
   id: 4,
   question: 'Is it safe for children?',
   answer: 'Yes it can be prescribed for children under the guidance of a healthcare professional with careful monitoring of dosage.',
 },
 {
   id: 5,
   question: 'Can I use Salamol inhaler with other medications?',
   answer: 'Always inform your doctor about all medicines you take to ensure there are no interactions or issues.',
 },
 {
   id: 6,
   question: 'What if symptoms persist?',
   answer: 'If you notice worsening symptoms or no improvement consult your healthcare provider for possible adjustments or further evaluation.',
 },
 {
   id: 7,
   question: 'How should I store my inhaler?',
   answer: 'Keep it at room temperature away from direct sunlight and ensure the cap is secured when not in use.',
 },
