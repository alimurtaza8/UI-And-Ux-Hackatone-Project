    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          <h2 className="text-3xl font-medium mb-6">Nytol 50mg
          ...
          Nytol 50mg is a short term remedy for occasional insomnia helping you drift off more easily and awaken feeling refreshed.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Nytol 50mg is formulated to provide short term relief for those who struggle with intermittent sleeplessness. By gently encouraging drowsiness it supports a natural transition into restful sleep so you can wake feeling more refreshed. This convenient tablet is most effective when combined with a consistent bedtime routine and healthy sleep habits. Nytol 50mg is intended for occasional use only and should not replace long term insomnia management strategies. Always follow the directions on the packaging and consult a healthcare professional if sleeplessness persists. With proper use Nytol 50mg can help you reclaim peaceful nights and energised mornings.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Nytol 50mg used for',
     answer: 'It is designed to help individuals with occasional insomnia fall asleep more easily and maintain restful sleep.',

   },
   {
    id: 2,
    question: 'How quickly does it work',
    answer: 'Many people feel drowsy within 20 to 30 minutes though individual responses may vary.',
  },
  {
   id: 3,
   question: 'Is it suitable for everyone',
   answer: 'It may not be recommended for certain health conditions or when taking other medications. Seek professional guidance first.',
 },
 {
   id: 4,
   question: 'Can I take it regularly',
   answer: 'Nytol 50mg is intended for short term use. If sleeplessness persists or recurs frequently consult a healthcare provider.',
 },
 {
   id: 5,
   question: 'Will I feel groggy in the morning',
   answer: 'Some people report mild grogginess but this usually subsides after the medication wears off.',
 },
 {
   id: 6,
   question: 'Are there side effects',
   answer: 'Possible side effects include dry mouth or dizziness. If you experience severe reactions stop use and seek medical advice.',
 },
 {
   id: 7,
   question: 'When should I consult a professional',
   answer: 'If sleeplessness lasts more than two weeks or worsens speak to a clinician for further evaluation and support.',
 },
