    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          ...
          Sumatriptan 50mg is a prescription medication designed to provide fast effective relief from moderate to severe migraines helping you resume your daily activities without enduring prolonged discomfort.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Sumatriptan 50mg belongs to the class of triptan medicines used for acute migraine attacks. By narrowing the blood vessels surrounding the brain and reducing inflammation it eases throbbing pain and other migraine symptoms such as nausea and light sensitivity. This targeted approach offers timely relief allowing you to return to normal activities sooner. Taken at the first sign of a migraine sumatriptan can help reduce both the duration and intensity of episodes. Always follow your clinician&apos;s instructions and discuss any existing conditions or medications to ensure sumatriptan is appropriate for you.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is sumatriptan used for',
     answer: 'Sumatriptan is prescribed to help manage acute migraine episodes reducing their severity and duration',

   },
   {
    id: 2,
    question: 'How quickly does it work',
    answer: 'Many people experience relief within 30 minutes though the exact response can vary between individuals',
  },
  {
   id: 3,
   question: 'Is it suitable for everyone',
   answer: 'Not all patients can use sumatriptan safely A thorough medical assessment is needed before starting treatment',
 },
 {
   id: 4,
   question: 'Are there side effects',
   answer: 'Possible side effects include dizziness nausea or mild pressure sensations Consult your clinician if concerns arise',
 },
 {
   id: 5,
   question: 'Can I use other migraine treatments alongside sumatriptan',
   answer: 'Always check with a medical professional before combining treatments to ensure safety and avoid interactions',
 },
 {
   id: 6,
   question: 'When should I avoid sumatriptan',
   answer: 'f you have certain heart or circulation problems or a history of stroke sumatriptan may not be suitable',
 },

 {
    id: 7,
    question: 'Do I need a prescription',
    answer: 'Yes sumatriptan requires a valid prescription after a consultation with your clinician',
  },
