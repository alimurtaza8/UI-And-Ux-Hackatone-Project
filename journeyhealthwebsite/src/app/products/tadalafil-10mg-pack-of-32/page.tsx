    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          ...
          Boost your intimate performance with Tadalafil 10mg (Pack of 32). You benefit from a cost effective, optimised dose that delivers superior results compared to lower strengths and alternative treatments.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Tadalafil 10mg (Pack of 32) is a proven prescription treatment for erectile dysfunction designed to enhance your intimate performance and boost your confidence. With a large pack, you enjoy a cost effective and reliable supply that offers faster and longer lasting results compared to lower strengths and other treatment options. You benefit from an optimised dose that supports improved blood flow and a satisfying intimate life. Under expert guidance, you receive personalised advice and regular follow ups to ensure your treatment is safe and effective. Embrace a renewed sense of vitality tailored to your needs.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Tadalafil 10mg (Pack of 32)?',
     answer: 'It is a prescription treatment for erectile dysfunction that provides you with 32 tablets of Tadalafil 10mg for a long term supply.',

   },
   {
    id: 2,
    question: 'How does Tadalafil 10mg compare to lower strengths?',
    answer: 'You benefit from a higher potency that offers faster and longer lasting results than lower strength options.',
  },
  {
   id: 3,
   question: 'How does this treatment differ from other options?',
   answer: 'Its proven efficacy and optimised dosing give you a reliable and effective choice over alternative treatments for erectile dysfunction.',
 },
 {
   id: 4,
   question: 'Who can benefit from Tadalafil 10mg (Pack of 32)?',
 ...
 {
    id: 7,
    question: 'Will Tadalafil 10mg improve your intimate performance?',
    answer: 'Yes, by effectively addressing erectile dysfunction, it helps boost your performance and restore your confidence in your intimate life.',
  },
