    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          <h2 className="text-3xl font-medium mb-6">Nytol Liquid 300ml
          ...
          Nytol Liquid is an over the counter sleep aid that helps promote restful nights by easing you into sleep and supporting a more refreshed morning.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Nytol Liquid is a gentle sleep aid that helps you fall asleep more easily when experiencing occasional sleeplessness. By providing a calming antihistamine effect it supports better rest and helps you wake feeling refreshed. Perfect for those seeking a short term solution Nytol Liquid should be taken as directed typically around 20 minutes before bedtime. Adopting good sleep habits alongside Nytol Liquid can enhance its effectiveness. If insomnia persists beyond two weeks consult your healthcare professional. Always review the label and instructions carefully especially if you have any underlying conditions or take other medications.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Nytol Liquid used for?',
     answer: 'It is used for short term relief of occasional sleeplessness helping you relax and drift off more easily.',

   },
   {
    id: 2,
    question: 'How does it work?',
    answer: 'Nytol Liquid contains an antihistamine that causes drowsiness which can promote a more restful sleep.',
  },
  {
   id: 3,
   question: 'When should I take Nytol Liquid?',
   answer: 'Most people take it around 20 minutes before bedtime to allow it to start working.',
 },
 {
   id: 4,
   question: 'Are there any common side effects?',
   answer: 'You may experience drowsiness dry mouth or dizziness. If you have concerns speak to a healthcare professional.',
 },
 {
   id: 5,
   question: 'Can I use Nytol Liquid with other medications?',
   answer: 'Always check with your pharmacist or doctor as it can interact with certain medicines or supplements.',
 },
 {
   id: 6,
   question: 'Is it suitable for everyone?',
   answer: 'It may not be suitable for individuals with certain conditions. Consult your doctor to ensure it is right for you.',
 },
 {
   id: 7,
   question: 'How long can I use Nytol Liquid?',
   answer: 'It is generally recommended for short term use. If sleep problems continue beyond two weeks seek medical advice.',
 },
