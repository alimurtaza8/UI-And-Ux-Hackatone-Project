    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          <h2 className="text-3xl font-medium mb-6">Period Delay Tablets
          ...
          Norethisterone for Period Delay is a safe, effective solution to control menstrual timing for travel, events or personal convenience under professional supervision.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Norethisterone is a reliable option to safely delay your period when required. This product enables you to manage your menstrual cycle for special occasions, travel or personal needs. It works by temporarily postponing menstruation under strict medical supervision. A consultation with a health professional is recommended prior to use to ensure suitability and discuss any potential side effects. Manufactured to the highest standards and used responsibly, Norethisterone provides effective period delay with careful dosage guidance to give you greater control over your cycle.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Norethisterone for Period Delay?',
     answer: 'It is a medication used to safely postpone the onset of menstruation for a short period.',

   },
   {
    id: 2,
    question: 'How does it work?',
    answer: 'It alters the hormonal balance temporarily to delay menstruation while maintaining cycle regularity.',
  },
  {
   id: 3,
   question: 'Is it safe to use?',
   answer: 'Yes, when used under the supervision of a healthcare professional and following the recommended dosage.',
 },
 {
   id: 4,
   question: 'When should I take it?',
   answer: 'It is typically taken a few days before your expected period; your doctor will advise the exact timing.',
 },
 {
   id: 5,
   question: 'Can it be used regularly?',
   answer: 'It is intended for occasional use and should not be considered a regular method of period management.',
 },
 {
   id: 6,
   question: 'Are there any side effects?',
   answer: 'Some users may experience minor side effects such as nausea or breast tenderness. Consult your doctor for guidance.',
 },
 {
   id: 7,
   question: 'Do I need a prescription?',
   answer: 'Yes, a consultation and prescription from a qualified health professional are required before use.',
 },
