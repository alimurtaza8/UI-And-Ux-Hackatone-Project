    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          <h2 className="text-3xl font-medium mb-6">Mounjaro 5mg
          ...
          Achieve your weight loss goals with Mounjaro 5mg. You enjoy balanced appetite control and enhanced benefits over lower strengths for your effective weight management journey.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Mounjaro 5mg is a prescription treatment designed for both men and women to support effective weight loss. It offers balanced appetite regulation and improved portion control compared to lower strengths. You benefit from enhanced results while adopting healthier eating habits. Administered under expert supervision, this treatment is part of a comprehensive weight management programme that includes regular check ups, personalised advice and lifestyle recommendations. Enjoy a transformative approach that supports your journey towards lasting results and renewed confidence.
...
const FAQSection = () => {
 ...
 const faqItems = [
   ...
   {
    id: 2,
    question: 'How does Mounjaro 5mg differ from lower strengths?',
    answer: 'It provides improved appetite regulation and balanced benefits, offering you enhanced results over lower strengths.'
  },
  {
   id: 3,
   question: 'How does the treatment work?',
   answer: 'It works by regulating your appetite and promoting better portion control, which helps you adopt healthier eating habits.'
 },
 {
   id: 4,
   question: 'Who can benefit from Mounjaro 5mg?',
   answer: 'Men and women facing weight management challenges can benefit from this treatment after a detailed medical assessment tailored to your needs.'
 },
 {
   id: 5,
   question: 'How is Mounjaro 5mg administered?',
   answer: 'The treatment is given by injection with comprehensive training provided so that you can safely and confidently self administer it.'
 },
 {
   id: 6,
   question: 'What support do you receive during treatment?',
   answer: 'You receive regular check ups, personalised guidance and lifestyle recommendations designed to optimise your weight loss journey.'
 },
 {
   id: 7,
   question: 'Can lifestyle changes improve your outcomes?',
   answer: 'Yes, combining Mounjaro 5mg with a balanced diet and regular exercise further enhances your results and supports lasting weight management.'
 },
