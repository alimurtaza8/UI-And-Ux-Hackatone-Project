...
Experience effective weight loss with Wegovy 1.7mg. Ideal for men and women seeking a safe, medically guided treatment to control appetite and enhance overall wellbeing.
...
Wegovy 1.7mg is a prescription treatment that supports sustainable weight loss for both men and women. Designed to regulate appetite signals and reduce hunger, it promotes healthier eating habits and improved portion control. Administered under the care of experienced healthcare professionals, this treatment is part of a comprehensive weight management programme. Our clinic offers personalised advice, regular check ups and continuous support to ensure safety and effectiveness. Embrace a transformative journey towards better health and confidence with a treatment that complements lifestyle changes such as balanced nutrition and regular exercise.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Wegovy 1.7mg?',
     answer: 'It is a prescription weight management treatment designed to control appetite and support sustainable weight loss for both men and women.',

   },
   {
    id: 2,
    question: 'How does Wegovy 1.7mg work?',
    answer: 'It works by regulating appetite signals, reducing hunger and promoting improved portion control to support healthier eating habits.',
  },
  {
   id: 3,
   question: 'Who is suitable for this treatment?',
   answer: 'Both men and women experiencing weight management challenges may benefit from Wegovy 1.7mg following a thorough assessment by our healthcare professionals.',
 },
 {
   id: 4,
   question: 'How is the treatment administered?',
   answer: 'Wegovy 1.7mg is administered by injection with clear instructions provided to ensure safe self administration.',
 },
 {
   id: 5,
   question: 'What support does the clinic offer?',
   answer: 'Our clinic provides regular check ups, personalised advice and ongoing support to guide you throughout your weight loss journey.',
 },
 {
   id: 6,
   question: 'Are lifestyle changes required?',
   answer: 'A balanced diet and regular exercise are recommended to complement the effects of Wegovy 1.7mg and achieve lasting results.',
 },

 {
    id: 7,
    question: 'Is Wegovy 1.7mg safe?',
    answer: 'When used under professional guidance, it is a safe and effective treatment option for weight loss.',
  },
