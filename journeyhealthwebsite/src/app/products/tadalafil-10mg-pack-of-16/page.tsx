    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          ...
          Enhance your performance with Tadalafil 10mg (Pack of 16). You benefit from a cost effective, optimised dose that outperforms lower strengths and alternative treatments for erectile dysfunction.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Tadalafil 10mg (Pack of 16) is a trusted prescription treatment for erectile dysfunction designed to boost your intimate performance and confidence. This larger pack provides you with a cost effective and reliable supply that offers faster and longer lasting results compared to lower strengths and other options. You benefit from an optimised dose that supports improved blood flow and a satisfying intimate life. Under expert guidance, you receive personalised advice and regular follow ups to ensure your treatment is safe and effective. Embrace a renewed sense of confidence and performance with a treatment tailored to your needs.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Tadalafil 10mg (Pack of 16)?',
     answer: 'It is a prescription treatment for erectile dysfunction that provides you with 16 tablets of Tadalafil 10mg for an effective and long term supply.',

   },
   {
    id: 2,
    question: 'How does Tadalafil 10mg compare to lower strengths?',
    answer: 'You benefit from a higher potency that delivers faster and longer lasting results than lower strength options.',
  },
  {
   id: 3,
   question: 'How does this treatment stand out from alternative options?',
   answer: 'Its proven efficacy and optimised dose make it a superior choice compared to other treatments available for erectile dysfunction.',
 },
 {
   id: 4,
   question: 'Who can benefit from Tadalafil 10mg (Pack of 16)?',
 ...
 {
   id: 5,
   question: 'How should you take Tadalafil 10mg?',
   answer: 'You should follow your healthcare provider\'s instructions for oral administration to ensure safe and effective use.',
 },
 {
   id: 6,
   question: 'What support do you receive during your treatment?',
   answer: 'You receive personalised advice, regular follow ups and lifestyle recommendations to help optimise your outcomes.',
 },

 {
    id: 7,
    question: 'Can Tadalafil 10mg improve your intimate performance?',
    answer: 'Yes, by effectively addressing erectile dysfunction, it enhances your performance and helps boost your confidence in your intimate life.',
  },
