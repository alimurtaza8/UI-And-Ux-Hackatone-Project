    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          <h2 className="text-3xl font-medium mb-6">Mounjaro 2.5mg
          ...
          Achieve gentle weight loss with Mounjaro 2.5mg. You enjoy a balanced treatment that minimises side effects compared to higher strengths for your comfortable weight management journey.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Mounjaro 2.5mg is a prescription treatment designed for both men and women to support your weight loss journey. This formulation offers a gentle approach compared to higher strengths, reducing the risk of unwanted side effects while effectively controlling your appetite. You can enjoy balanced results that complement your healthy eating habits and active lifestyle. Our clinic provides expert supervision, personalised guidance and regular check ups to ensure your treatment is safe and effective. Embrace a tailored weight management programme that respects your needs and supports sustainable progress.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Mounjaro 2.5mg?',
     answer: 'It is a prescription weight management treatment designed to offer you a gentle and effective approach to weight loss.',

   },
   {
    id: 2,
    question: 'How does Mounjaro 2.5mg differ from higher strengths?',
    answer: 'It provides a balanced and milder option that reduces the risk of side effects while still supporting effective appetite control.'
  },
  {
   id: 3,
   question: 'Who is suitable for Mounjaro 2.5mg?',
   answer: 'Both men and women who prefer a gentler treatment to support your weight loss journey may benefit after a comprehensive medical assessment.'
 },
 {
   id: 4,
   question: 'How does the treatment work?',
   answer: 'It works by regulating your appetite and promoting healthier eating habits that contribute to sustainable weight management.'
 },
 {
   id: 5,
   question: 'How is Mounjaro 2.5mg administered?',
   answer: 'The treatment is given by injection and you will receive thorough training to safely self administer your doses.'
 },
 {
   id: 6,
   question: 'What support do you receive during treatment?',
   answer: 'Our clinic offers personalised guidance, regular check ups and lifestyle recommendations to help optimise your results.'
 },
 {
   id: 7,
   question: 'Are lifestyle changes important with Mounjaro 2.5mg?',
   answer: 'Yes, combining your treatment with a balanced diet and regular exercise further enhances your outcomes and supports long term weight management.'
 },
