    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          ...
          Promethazine 25mg supports restful sleep and helps ease jet lag by reducing nausea and encouraging relaxation, making long journeys more comfortable.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Promethazine 25mg can support a better rest cycle and help you adapt more quickly when crossing time zones. This antihistamine is commonly used to manage motion sickness and ease discomfort during travel. It may also help you fall asleep more easily, reducing the impact of jet lag and improving overall travel experiences. By blocking certain chemical signals in the body, Promethazine assists in relaxation, promoting deeper and more refreshing sleep. Always speak with a healthcare professional before using any medication, especially if you have existing conditions or take other prescriptions. Embrace more comfortable and restful journeys with Promethazine 25mg.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'How does Promethazine 25mg help with jet lag?',
     answer: 'It promotes relaxation and can encourage better sleep, which may reduce the time it takes to adjust to new time zones.',

   },
   {
    id: 2,
    question: 'Can Promethazine 25mg also act as a sleep aid?',
    answer: 'Yes it has sedative properties that can help you relax and fall asleep more easily.',
  },
  {
   id: 3,
   question: 'When should I take Promethazine 25mg for best results?',
   answer: 'Your doctor may suggest taking it before or during travel to help manage motion sickness and support sleep.',
 },
 {
   id: 4,
   question: 'Are there any common side effects?',
   answer: 'Possible side effects include drowsiness and dry mouth. Always consult a healthcare professional if you experience severe or persistent symptoms.',
 },
 {
   id: 5,
   question: 'Is Promethazine 25mg suitable for everyone?',
   answer: 'It may not be suitable if you have certain medical conditions or take other medications. Discuss with your doctor first.',
 },
 {
   id: 6,
   question: 'Can I drive or operate machinery after taking Promethazine 25mg?',
   answer: 'It can cause drowsiness so avoid these activities until you know how it affects you.',
 },
 {
   id: 7,
   question: 'What if I miss a dose?',
   answer: 'ake it as soon as you remember. If it is nearly time for your next dose skip the missed one and continue as directed.',
 },
