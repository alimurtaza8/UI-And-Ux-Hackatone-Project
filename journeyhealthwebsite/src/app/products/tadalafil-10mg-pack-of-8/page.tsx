    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          ...
          Elevate your performance with Tadalafil 10mg (Pack of 8). You benefit from a proven treatment that delivers faster and longer lasting results than lower strengths and alternative options.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Tadalafil 10mg (Pack of 8) is a prescription treatment for erectile dysfunction designed to enhance your intimate performance. This optimised dose offers faster and longer lasting results compared to lower strengths and other treatments. You benefit from a reliable and cost effective supply that supports your ongoing treatment needs. With personalised guidance from our experienced team and regular follow ups, you can enjoy improved results and renewed confidence. Embrace a satisfying intimate life with a treatment that truly prioritises your wellbeing.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Tadalafil 10mg (Pack of 8)?',
     answer: 'It is a prescription treatment for erectile dysfunction that provides you with a supply of 8 tablets to support your treatment journey.',

   },
   {
    id: 2,
    question: 'How does Tadalafil 10mg benefit you over lower strengths?',
    answer: 'You enjoy a higher potency that offers faster and longer lasting results, making it more effective than lower strength options.',
  },
  {
   id: 3,
   question: 'How does this treatment compare to other options?',
   answer: 'Its proven efficacy and sustained performance make it a superior choice over alternative treatments for erectile dysfunction.',
 },
 {
   id: 4,
   question: 'Who can benefit from Tadalafil 10mg (Pack of 8)?',
 ...
 {
    id: 7,
    question: 'Can Tadalafil 10mg improve your intimate life?',
    answer: 'Yes, by effectively addressing erectile dysfunction, it enhances your performance and helps boost your confidence.',
  },
