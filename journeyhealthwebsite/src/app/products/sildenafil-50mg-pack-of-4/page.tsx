    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          ...
          Enhance your performance with Sildenafil 50mg (Pack of 4). You benefit from an optimised dose for erectile dysfunction that offers improved results over alternative options and lower strengths.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Sildenafil 50mg is a proven prescription treatment designed to address your erectile dysfunction. Offered in a pack of 4, it provides a consistent and effective solution that stands out against alternative options and lower strengths. You benefit from its fast action and enhanced potency, helping you regain confidence and enjoy a more satisfying intimate life. Under expert guidance, you receive personalised advice and support to ensure your treatment is safe and effective, making your journey to improved sexual health both straightforward and rewarding.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Sildenafil 50mg (Pack of 4)?',
     answer: 'It is a prescription treatment for erectile dysfunction, provided in a pack of 4 to offer you a consistent supply for your treatment.',

   },
   {
    id: 2,
    question: 'How does Sildenafil 50mg benefit you over other options?',
    answer: 'You enjoy an optimised dose that delivers reliable and enhanced results compared to alternative treatments.',
  },
  {
   id: 3,
   question: 'How does it compare to lower strengths?',
   answer: 'Sildenafil 50mg offers increased potency and faster action, making it more effective than lower strength options for improving your performance.',
 },
 {
   id: 4,
   question: 'Who can benefit from Sildenafil 50mg?',
   answer: 'Men experiencing erectile dysfunction may benefit from this treatment after a comprehensive medical assessment tailored to your needs.',
 },
 {
   id: 5,
   question: 'How is Sildenafil 50mg administered?',
   answer: 'It is taken orally with guidance provided to ensure you use your medication safely and effectively.',
 },
 {
   id: 6,
   question: 'What support do you receive during treatment?',
   answer: 'You receive personalised advice, regular follow ups and lifestyle recommendations to help optimise your results.',
 },
 {
   id: 7,
   question: 'Can Sildenafil 50mg improve your confidence?',
   answer: 'Yes, by addressing your erectile issues and enhancing your performance, you can enjoy improved confidence and a more satisfying intimate life.',
 },
