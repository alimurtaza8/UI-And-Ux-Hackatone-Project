...
Discover Wegovy 1mg for effective weight loss. Suitable for both men and women seeking a safe, clinically supported solution for weight management.
...
Wegovy 1mg is a prescription treatment that aids in controlling appetite and achieving sustainable weight loss for both men and women. Administered under expert guidance, it supports healthier eating habits and a balanced lifestyle. Our clinic offers regular check ups and personalised advice to ensure a safe and effective journey towards improved wellbeing and confidence. Embrace a comprehensive weight management plan with a treatment trusted by healthcare professionals.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Wegovy 1mg?',
     answer: 'Wegovy 1mg is a prescription weight management treatment designed to help control appetite and support sustainable weight loss for both men and women.',

   },
   {
    id: 2,
    question: 'How does Wegovy 1mg work?',
    answer: 'It works by regulating the hormones involved in appetite control, leading to reduced hunger and improved portion control.',
  },
  {
   id: 3,
   question: 'Who can benefit from this treatment?',
   answer: 'Men and women experiencing challenges with weight management may be eligible for Wegovy 1mg after a thorough assessment by our healthcare professionals.',
 },
 {
   id: 4,
   question: 'What are the benefits of using Wegovy 1mg?',
   answer: 'Benefits include improved appetite control, support for healthier eating habits and assistance in achieving sustainable weight loss.',
 },
 {
   id: 5,
   question: 'How is Wegovy 1mg administered?',
   answer: 'The treatment is given by injection with clear instructions provided by our trained staff to ensure proper self administration.',
 },
 {
   id: 6,
   question: 'What support is available during treatment?',
   answer: 'Our clinic provides regular check ups, personalised guidance and ongoing support throughout your weight loss journey.',
 },

 {
    id: 7,
    question: 'Are lifestyle changes necessary with Wegovy 1mg?',
    answer: 'Yes, combining Wegovy 1mg with a balanced diet and regular exercise enhances its effectiveness and supports long term weight management.',
  },
