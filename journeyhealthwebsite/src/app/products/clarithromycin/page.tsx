    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          <h2 className="text-3xl font-medium mb-6">Clarithromycin</h2>
          <p className="text-gray-200 text-lg leading-relaxed">
         
          Clarithromycin is a macrolide antibiotic that helps clear strep throat by slowing bacterial growth, easing inflammation, and promoting faster symptom relief.          </p>
        </div>
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Clarithromycin is a macrolide antibiotic used to treat strep throat, especially in individuals who are unable to take penicillin. By stopping bacterial growth, it reduces inflammation and helps relieve painful swallowing, fever, and sore throat. Regularly taking Clarithromycin as prescribed can lead to faster recovery and prevent complications. Always complete the full course even if symptoms improve early to ensure the infection is fully cleared. Inform your doctor about any allergies or medications you are taking, as Clarithromycin can interact with certain medicines. If symptoms do not improve or worsen after a few days, seek further medical advice.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'How does Clarithromycin treat strep throat?',
     answer: 'It works by blocking bacterial growth, which helps reduce inflammation and ease symptoms like sore throat and fever.'
   },
   {
    id: 2,
    question: 'Is Clarithromycin suitable if I am allergic to penicillin?',
    answer: 'Yes it is often prescribed as an alternative for those with penicillin allergies, but always consult a healthcare professional first.'
  },
  {
   id: 3,
   question: 'How long does it take to feel better?',
   answer: 'Many people notice improvement within a few days, though it is important to finish the full course for best results.'
 },
 {
   id: 4,
   question: 'What if I miss a dose?',
   answer: 'Take the missed dose as soon as you remember, unless it is nearly time for your next dose. Do not double up doses.'
 },
 {
   id: 5,
   question: 'Are there any common side effects?',
   answer: 'Mild gastrointestinal upset, headache, or changes in taste can occur. If you experience severe reactions contact your doctor.'
 },
 {
   id: 6,
   question: 'Should I stop taking Clarithromycin when I feel better?',
   answer: 'Always complete the prescribed course to ensure the infection is fully treated and to avoid antibiotic resistance.'
 },
 {
   id: 7,
   question: 'When should I seek further medical help?',
   answer: 'If your symptoms worsen, fail to improve after a few days, or you experience severe side effects, consult your doctor.'
 },
