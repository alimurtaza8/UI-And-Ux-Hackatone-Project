    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          ...
          Achieve your weight loss goals with The Step Bundle. You benefit from Mounjaro 5mg, 7.5mg and 10mg for a flexible and effective approach to appetite control.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          The Step Bundle combines Mounjaro 5mg, 7.5mg and 10mg into one comprehensive weight management package designed for both men and women. You can adjust your dose as your treatment progresses to optimise your results. This flexible approach offers superior benefits over individual options and single strength treatments. By regulating your appetite and promoting better portion control, you can adopt healthier eating habits. Under expert supervision, you receive personalised guidance, regular check ups and lifestyle advice to support your journey to sustainable weight loss.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is The Step Bundle?',
     answer: 'It is a comprehensive weight management package that includes Mounjaro 5mg, 7.5mg and 10mg to give you flexible dosing options for your treatment.',

   },
   {
    id: 2,
    question: 'How does The Step Bundle benefit you over individual options?',
    answer: 'It provides a progressive treatment plan that allows you to adjust your dose as needed, offering improved results compared to using a single strength.',
  },
  {
   id: 3,
   question: 'How does The Step Bundle compare to other strengths?',
   answer: 'The bundle combines multiple strengths to offer you a tailored approach that can deliver superior outcomes over treatments with only one strength.',
 },
 {
   id: 4,
   question: 'Who can benefit from The Step Bundle?',
   answer: 'Both men and women facing weight management challenges may benefit from this comprehensive package after a detailed medical assessment.',
 },
 {
   id: 5,
   question: 'How is the treatment administered?',
   answer: 'The treatment is given by injection and you receive thorough training to safely and confidently self administer your doses.',
 },
 {
   id: 6,
   question: 'What support do you receive during your treatment?',
   answer: 'You benefit from regular check ups, personalised guidance and lifestyle recommendations designed to enhance your treatment outcomes.',
 },
 {
   id: 7,
   question: 'Are lifestyle changes important with The Step Bundle?',
   answer: 'Yes, combining your treatment with a balanced diet and regular exercise further improves your results and supports long term weight management.',
 },
