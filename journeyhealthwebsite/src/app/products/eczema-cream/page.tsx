    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          <h2 className="text-3xl font-medium mb-6">Eczema Cream          </h2>
          <p className="text-gray-200 text-lg leading-relaxed">
         
          Betnovate offers effective relief for skin eczema symptoms. It soothes inflamed skin and reduces irritation quickly, helping patients regain healthy and comfortable skin.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Betnovate is a trusted treatment for skin eczema. Our advanced formula, prescribed by health specialists, eases discomfort, reduces inflammation and restores the skin&apos;s natural balance. Betnovate effectively relieves itch and redness, offering rapid relief and improving skin appearance. Ideal for managing flare ups and maintaining healthy skin, our treatment is gentle on sensitive skin and easy to apply. Experience the difference with Betnovate and reclaim your skin confidence. Always follow medical advice and consult your doctor for the correct dosage and usage instructions.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Betnovate used for?',
     answer: 'Betnovate is used to relieve the symptoms of skin eczema including itch, redness and inflammation.'
   },
   {
    id: 2,
    question: 'How should Betnovate be applied?',
    answer: 'Apply a thin layer on the affected area as directed by your doctor for best results.'
  },
  {
   id: 3,
   question: 'Can Betnovate be used long term?',
   answer: 'It is generally recommended for short term flare ups; prolonged use should be monitored by your doctor.'
 },
 {
   id: 4,
   question: 'Are there any side effects?',
   answer: 'Some users may experience skin thinning or irritation. If any adverse reactions occur, seek medical advice immediately.'
 },
 {
   id: 5,
   question: 'Is Betnovate suitable for children?',
   answer: 'Betnovate is usually prescribed for adults. Please consult your doctor before use in children.'
 },
 {
   id: 6,
   question: 'How quickly does Betnovate work?',
   answer: 'Many patients notice improvement within a few days when used regularly as advised.'
 },
 {
   id: 7,
   question: 'Where can I obtain Betnovate?',
   answer: 'Betnovate is available through prescription at our clinic. Please consult your healthcare provider for further advice.'
 },
