    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          <h2 className="text-3xl font-medium mb-6">Mounjaro 10mg


          </h2>
          <p className="text-gray-200 text-lg leading-relaxed">
         
          Experience superior weight loss with Mounjaro 10mg. You can benefit from enhanced appetite control and improved results compared to lower strengths for your weight management journey.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Mounjaro 10mg is a prescription weight management treatment designed for both men and women. It offers enhanced appetite regulation and improved portion control over lower strengths, helping you adopt healthier eating habits. Under expert supervision, you receive personalised guidance, regular check ups and lifestyle advice to maximise your treatment benefits. Embrace a transformative approach to weight loss that supports sustainable results and boosts your confidence. Enhance your journey with a treatment that truly works for your long term wellbeing.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Mounjaro 10mg?',
     answer: 'It is a prescription weight management treatment designed to help you control your appetite and achieve sustainable weight loss.',

   },
   {
    id: 2,
    question: 'How does Mounjaro 10mg differ from lower strengths?',
    answer: 'Mounjaro 10ml provides enhanced appetite control and improved results compared to lower strengths, making it a more effective option for your weight loss journey.'
  },
  {
   id: 3,
   question: 'How does the treatment work?',
   answer: 'It works by regulating your appetite and promoting healthier portion control, which supports your efforts to lose weight effectively.'
 },
 {
   id: 4,
   question: 'Who can benefit from Mounjaro 10mg?',
   answer: 'Men and women experiencing weight management challenges can benefit from this treatment after a comprehensive medical assessment tailored to your needs.'
 },
 {
   id: 5,
   question: 'How is Mounjaro 10mg administered?',
   answer: 'It is given by injection with thorough training provided to ensure you can safely and confidently self administer the treatment.'
 },
 {
   id: 6,
   question: 'What support do you receive during treatment?',
   answer: 'You benefit from regular check ups, personalised advice and lifestyle recommendations designed to enhance your treatment outcomes.'
 },
 {
   id: 7,
   question: 'Will lifestyle changes improve the results?',
   answer: 'Yes, combining Mounjaro 10ml with a balanced diet and regular exercise further improves your results and supports lasting weight management.'
 },
