    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          <h2 className="text-3xl font-medium mb-6">Priligy 30mg (3 Tablets)
          ...
          Priligy 30mg (3 Tablets) is a trusted treatment that assists men in managing premature ejaculation, promoting improved control and intimacy with a prescription-based solution.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Priligy 30mg provides an effective treatment for men experiencing premature ejaculation. These tablets help delay ejaculation and enhance control during intimacy. Manufactured to the highest standards, this prescription product is recommended by healthcare professionals for on demand use. Each pack contains three tablets to support a more confident and satisfying sexual experience. Always consult your healthcare provider to determine if Priligy 30mg is the best option for your needs.
 ...
 const faqItems = [
   {
     ...
     answer: 'Priligy is used to treat premature ejaculation by helping delay ejaculation and improve control during intimacy.',

   },
   {
    id: 2,
    question: 'How does Priligy work?',
    answer: 'The tablets work by modulating nerve signals that trigger ejaculation, allowing for a longer lasting experience.',
  },
  {
   id: 3,
   question: 'Is Priligy safe?',
   answer: 'Yes, Priligy is a clinically approved treatment and is prescribed by healthcare professionals after a full evaluation.',
 },
 {
   id: 4,
   question: 'What is the recommended dosage?',
   answer: 'The typical dosage is 30mg per tablet taken on demand. Your doctor will provide the best advice for your situation.',
 },
 {
   id: 5,
   question: 'When should I take Priligy?',
   answer: 'It is recommended to take Priligy one hour before anticipated sexual activity for optimal benefits.',
 },
 {
   id: 6,
   question: 'Are there any side effects?',
   answer: 'Some men may experience mild side effects such as headache or dizziness. Consult your healthcare provider if you have concerns.',
 },
 {
   id: 7,
   question: 'Do I need a prescription?',
   answer: 'Yes, Priligy is available only with a prescription to ensure it is used safely and appropriately.',
 },
