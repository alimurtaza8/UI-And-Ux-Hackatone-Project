    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          <h2 className="text-3xl font-medium mb-6">Nytol 25mg
          ...
          Nytol 25mg is a gentle short term sleep aid for occasional sleeplessness helping you relax and drift off more easily so you can awaken feeling refreshed.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Nytol 25mg is designed to promote a restful night&apos;s sleep by gently inducing drowsiness helping you settle down when insomnia strikes. With its easy to swallow tablets Nytol 25mg provides a convenient solution for those who experience occasional sleeplessness. This sleep aid is intended for short term use ensuring you receive the support you need without risking long term dependency. Always follow the recommended dosage and consider practicing healthy bedtime habits such as reducing caffeine intake and establishing a calming evening routine. If your sleep issues persist or worsen consult a healthcare professional for personalised guidance and alternatives.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Nytol 25mg used for',
     answer: 'It is intended to help people with occasional sleeplessness drift off more easily and stay asleep longer.',

   },
   {
    id: 2,
    question: 'Is Nytol 25mg suitable for everyone',
    answer: 'It may not be suitable if you have certain medical conditions or are taking other medications. Consult a healthcare professional first.',
  },
  {
   id: 3,
   question: 'How quickly does it work',
   answer: 'Most individuals feel drowsy within 20 to 30 minutes though this can vary from person to person.'
 },
 {
   id: 4,
   question: 'Can I use it every night',
   answer: 'It is recommended for short term use. If sleeplessness continues you should seek professional advice.'
 },
 {
   id: 5,
   question: 'Are there side effects',
   answer: 'Mild grogginess or a dry mouth may occur. If side effects persist or worsen speak to a clinician.',
 },
 {
   id: 6,
   question: 'Will Nytol 25mg cause dependence',
   answer: 'When used as directed the risk of dependence is low. Always follow the dosage instructions carefully.',
 },
 {
   id: 7,
   question: 'When should I consult a healthcare professional',
   answer: 'If you experience persistent insomnia for more than two weeks or if symptoms worsen consult your clinician for further evaluation.',
 },
