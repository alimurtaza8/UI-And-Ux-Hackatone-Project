    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          <h2 className="text-3xl font-medium mb-6">Mounjaro 15mg
          ...
          Experience superior weight management with Mounjaro 15mg. Ideal for men and women seeking enhanced appetite control and greater benefits compared to lower strengths.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Mounjaro 15mg is a prescription weight management treatment designed to deliver effective and sustainable results for both men and women. This advanced formulation offers improved appetite regulation and greater benefits over lower strengths, supporting healthier eating habits and enhanced portion control. Administered under the care of experienced professionals, our clinic provides personalised guidance, regular check ups and lifestyle advice. Enjoy a transformative approach to weight loss that combines cutting edge treatment with comprehensive support to help you achieve lasting results and renewed confidence.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Mounjaro 15ml?',
     answer: 'It is a prescription weight management treatment designed for both men and women to support effective weight loss.',

   },
   {
    id: 2,
    question: 'How does Mounjaro 15ml differ from lower strengths?',
    answer: 'Mounjaro 15ml offers enhanced appetite suppression and improved results, providing greater benefits compared to lower strengths.'
  },
  {
   id: 3,
   question: 'How does the treatment work?',
   answer: 'It works by regulating appetite and promoting better portion control to help you adopt healthier eating habits.'
 },
 {
   id: 4,
   question: 'Who can benefit from Mounjaro 15ml?',
   answer: 'Men and women facing weight management challenges may benefit from this treatment after a thorough medical assessment.'
 },
 {
   id: 5,
   question: 'How is Mounjaro 15ml administered?',
 ...
 },
 {
   ...
   answer: 'Our clinic offers personalised advice, regular check ups and lifestyle recommendations throughout your weight loss journey.'
 },
 {
   id: 7,
   question: 'Can lifestyle changes improve outcomes?',
   answer: 'Yes, a balanced diet and regular exercise are recommended to further enhance the benefits of Mounjaro 15ml.'
 },
