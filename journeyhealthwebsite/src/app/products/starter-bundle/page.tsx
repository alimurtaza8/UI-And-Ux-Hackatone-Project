    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          ...
          Kickstart your weight loss journey with The Starter Bundle. You benefit from flexible dosing using Mounjaro 2.5mg 5mg and 7.5mg for improved appetite control compared to single options.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          The Starter Bundle includes Mounjaro 2.5mg 5mg and 7.5mg and is designed to provide you with a tailored approach to weight management. You begin with a gentle dose and progress as needed to optimise your results. This comprehensive package offers flexible dosing options and improved appetite control compared to individual strengths. Our experienced team provides regular check ups, personalised guidance and lifestyle advice to support your journey. Embrace a transformative approach that adapts to your needs and helps you achieve lasting results.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is The Starter Bundle?',
     answer: 'It is a comprehensive weight management package that includes Mounjaro 2.5mg 5mg and 7.5mg designed to help you begin your weight loss journey with a tailored approach.',

   },
   {
    id: 2,
    question: 'How does The Starter Bundle benefit you over individual options?',
    answer: 'It offers flexible dosing that lets you start gently and progress gradually, providing you with improved appetite control and better results than a single strength treatment.',
  },
  {
   id: 3,
   question: 'How does it compare to higher strengths?',
   answer: 'Unlike higher strengths, this bundle offers a gradual progression that minimises side effects while still delivering effective weight loss support.',
 },
 {
   id: 4,
   question: 'Who is suitable for The Starter Bundle?',
   answer: 'Both men and women facing weight management challenges can benefit after a thorough medical assessment that addresses your individual needs.',
 },
 {
   id: 5,
   question: 'How is the treatment administered?',
   answer: 'You will receive your injections with comprehensive training provided to ensure safe and confident self administration.',
 },
 {
   id: 6,
   question: 'What support do you receive during treatment?',
   answer: 'Our clinic offers regular check ups, personalised guidance and lifestyle advice to help you achieve optimal results.',
 },
 {
   id: 7,
   question: 'Can lifestyle changes improve your outcomes?',
   answer: 'Yes, combining The Starter Bundle with a balanced diet and regular exercise further enhances your results and supports sustainable weight management.',
 },
