...
//           <h2 className="text-3xl font-medium mb-6">Allevia - 120mg</h2>
//           <p className="text-gray-200">
//             Allevia 120mg is a non-drowsy antihistamine that provides fast and effective relief from hay fever and allergy symptoms.
//           </p>
//         </div>
...
//             Containing fexofenadine hydrochloride, Allevia 120mg blocks histamine to reduce sneezing, runny nose, itchy eyes, and skin irritation. It works within an hour and lasts up to 24 hours, making it ideal for daily use. This medication is suitable for adults and children over 12 suffering from seasonal allergies.
//           </p>
//         </div>
//       </div>
//     </div>
