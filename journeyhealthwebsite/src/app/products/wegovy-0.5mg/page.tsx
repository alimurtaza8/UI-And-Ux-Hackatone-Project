...
Experience effective weight loss with Wegovy 0.5mg. Suitable for men and women seeking a clinically proven, safe solution for managing their weight.
...
Wegovy 0.5mg is a prescription treatment that supports sustainable weight loss for both men and women. It works by regulating appetite and reducing hunger, making it easier to adopt healthier eating habits. Our clinic provides expert guidance and regular check ups to ensure a safe and effective journey. Experience improved wellbeing and confidence with a tailored treatment plan designed to complement lifestyle changes such as a balanced diet and exercise.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Wegovy 0.5mg?',
     answer: 'Wegovy 0.5mg is a prescription weight management treatment that helps control appetite and supports healthy weight loss for both men and women.',

   },
   {
    id: 2,
    question: 'How does Wegovy work?',
    answer: 'It works by influencing the hormones that regulate hunger and fullness, leading to reduced appetite and better portion control.',
  },
  {
   id: 3,
   question: 'Who is a candidate for this treatment?',
   answer: 'Men and women experiencing challenges with weight management may be eligible, following a thorough assessment by our healthcare professionals.',
 },
 {
   id: 4,
   question: 'Is the treatment safe?',
   answer: 'When used under professional guidance, Wegovy 0.5mg is considered safe and effective for achieving weight loss goals.',
 },
 {
   id: 5,
   question: 'How is Wegovy administered?',
   answer: 'It is administered by injection after a comprehensive training session to ensure self administration is performed correctly.',
 },
 {
   id: 6,
   question: 'Will I receive support during my treatment?',
   answer: 'Yes, our clinic offers personalised advice, regular check ups and continuous support throughout your weight loss journey.',
 },

 {
    id: 7,
    question: 'Are lifestyle changes recommended with Wegovy?',
    answer: 'A balanced diet and regular exercise are advised to enhance the effectiveness of your treatment and promote lasting results.',
  },
