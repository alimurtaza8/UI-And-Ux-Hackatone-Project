    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          ...
          Priligy 30mg (6 Tablets) is an effective treatment for premature ejaculation that enhances control and intimacy for men using a prescription based solution.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Priligy 30mg offers an effective solution for men dealing with premature ejaculation. Each tablet is designed to help delay ejaculation and improve control during intimacy. Manufactured to high quality standards, this prescription based treatment is recommended by healthcare professionals for on demand use. The pack contains six tablets to support a more satisfying sexual experience and boost confidence in intimate moments. Always consult your healthcare provider to ensure this treatment is right for you and to discuss the best dosage and usage guidelines.
 ...
 const faqItems = [
   {
     ...
     answer: 'Priligy is used to treat premature ejaculation by delaying ejaculation and enhancing control during intimacy.',

   },
   {
    id: 2,
    question: 'How does Priligy work?',
    answer: 'It works by modulating nerve signals that trigger ejaculation to help prolong intimate moments.',
  },
  {
   id: 3,
   question: 'What is the recommended dosage?',
   answer: 'Typically, one tablet is taken on demand about one hour before sexual activity. Always follow your doctor’s advice.',
 },
 {
   id: 4,
   question: 'Is Priligy safe?',
   answer: 'Yes, it is a clinically approved treatment prescribed after a thorough evaluation by healthcare professionals',
 },
 {
   id: 5,
   question: 'What should I do if I miss a dose?',
   answer: 'Priligy is taken on demand so missing a tablet is not usually an issue. Consult your healthcare provider if you have any concerns.',
 },
 {
   id: 6,
   question: 'Are there any side effects?',
   answer: 'Some men may experience mild side effects such as headache or dizziness. Inform your doctor if these symptoms persist.',
 },
 {
   id: 7,
   question: 'Do I need a prescription?',
   answer: 'Yes, Priligy is available only with a prescription to ensure safe and appropriate usage.',
 },
