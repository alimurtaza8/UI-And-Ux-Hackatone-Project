    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          ...
          Enhance your performance with Sildenafil 50mg in a pack of 8. You enjoy a reliable supply that offers improved results compared to alternative treatments and lower strengths.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Sildenafil 50mg is a proven prescription treatment for erectile dysfunction designed to help you regain confidence in your intimate life. Offered in a pack of 8, it provides you with a reliable supply to support your treatment needs. This formulation offers enhanced potency and faster results compared to alternative options and lower strengths. Under expert guidance, you receive personalised advice and support to ensure your treatment is safe and effective. Enjoy a more satisfying intimate life with a treatment that is trusted by healthcare professionals and tailored to your needs.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Sildenafil 50mg (Pack of 8)?',
     answer: 'It is a prescription treatment for erectile dysfunction offered in a pack of 8, providing you with a reliable and convenient supply for your treatment.',

   },
   {
    id: 2,
    question: 'How does Sildenafil 50mg benefit you over other options?',
    answer: 'You benefit from a proven dose that delivers enhanced potency and faster results compared to alternative treatments.',
  },
  {
   id: 3,
   question: 'How does it compare to lower strengths?',
   answer: 'Sildenafil 50mg offers improved effectiveness and a more consistent response, making it a superior option compared to lower strength formulations.',
 },
 {
   id: 4,
   question: 'Who can benefit from this treatment?',
   answer: 'Men experiencing erectile dysfunction may find this treatment beneficial after a thorough medical assessment tailored to your needs.',
 },
 {
   id: 5,
   question: 'How is the treatment administered?',
   answer: 'It is taken orally with clear guidance provided to ensure you use your medication safely and effectively',
 },
 {
   id: 6,
   question: 'What support do you receive during treatment?',
   answer: 'You receive personalised advice, regular follow ups and lifestyle recommendations to help optimise your treatment outcomes.',
 },
 {
   id: 7,
   question: 'Will Sildenafil 50mg improve your intimate life?',
   answer: 'Yes, by addressing erectile dysfunction, it helps improve your performance and confidence, leading to a more satisfying intimate life.',
 },
