    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          <h2 className="text-3xl font-medium mb-6">Omeprazole
          ...
          Omeprazole is a proton pump inhibitor that reduces excess stomach acid easing heartburn and reflux while promoting better digestive comfort.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Omeprazole helps reduce the production of stomach acid offering relief from symptoms of heartburn acid reflux and ulcers. By targeting the source of acid build up it can soothe discomfort and aid in your overall digestion. It is often prescribed for short term or long term management of common gastrointestinal problems depending on individual needs. Taking Omeprazole regularly as directed by your healthcare professional can help prevent acid related damage to the oesophagus. Maintaining a balanced diet avoiding trigger foods and following your prescription advice all play a role in achieving the best results. If symptoms persist always seek further guidance from a medical professional.
 ...
 const faqItems = [
   {
     ...
     answer: 'Omeprazole is used to reduce stomach acid and relieve symptoms of heartburn acid reflux and certain ulcers.',

   },
   {
    id: 2,
    question: 'How does it help with acid reflux?',
    answer: 'It blocks the enzyme responsible for producing acid helping to alleviate discomfort and prevent damage to the oesophagus.',
  },
  {
   id: 3,
   question: 'How long before I see results?',
   answer: 'Many people notice improvement within a few days but it may take up to four weeks for full benefits.',
 },
 {
   id: 4,
   question: 'Are there any side effects?',
   answer: 'Possible side effects include headache nausea diarrhoea or abdominal pain. Consult your healthcare provider if any symptoms concern you.',
 },
 {
   id: 5,
   question: 'Can I take Omeprazole with other medications?',
   answer: 'Some medicines may interact so inform your doctor about all prescriptions or supplements you are taking.',
 },
 {
   id: 6,
   question: 'How should I take Omeprazole?',
   answer: 'Swallow capsules whole with water usually before a meal as directed by your healthcare professional.',
 },
 {
   id: 7,
   question: 'When should I seek further advice?',
   answer: 'If your symptoms worsen or persist after a few weeks consult a doctor to reassess your treatment plan.',
 },
