    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          <h2 className="text-3xl font-medium mb-6">Mounjaro 12.5mg
          ...
          Discover Mounjaro 12.5mg for effective weight management. Ideal for men and women seeking balanced appetite control and notable benefits compared to lower strengths.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Mounjaro 12.5mg is a prescription weight management treatment designed to support sustainable results for both men and women. This formulation offers balanced appetite regulation and improved portion control compared to lower strengths, helping you adopt healthier eating habits. Administered under expert supervision, our clinic provides personalised guidance, regular check ups and lifestyle advice to complement your treatment. Enjoy a transformative approach to weight loss with a treatment that optimises benefits and fosters long term wellbeing and confidence.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Mounjaro 12.5mg?',
     answer: 'It is a prescription weight management treatment designed for men and women to aid effective weight loss.',

   },
   {
    id: 2,
    question: 'How does Mounjaro 12.5mg differ from lower strengths?',
    answer: 'This formulation offers balanced appetite control and improved results compared to lower strengths, making it an ideal option for many patients.'
  },
  {
   id: 3,
   question: 'How does the treatment work?',
   answer: 'It works by regulating appetite and promoting healthier portion control to support sustainable weight loss.'
 },
 {
   id: 4,
   question: 'Who can benefit from Mounjaro 12.5mg?',
   answer: 'Men and women facing weight management challenges may benefit from this treatment after a detailed medical assessment.'
 },
 {
   id: 5,
   question: 'How is Mounjaro 12.5mg administered?',
   answer: 'The treatment is given by injection with comprehensive training provided to ensure safe self administration.'
 },
 {
   id: 6,
   question: 'What support is available during treatment?',
   answer: 'Our clinic offers regular check ups, personalised advice and lifestyle recommendations throughout your weight loss journey.'
 },
 {
   id: 7,
   question: 'Can lifestyle changes improve its effectiveness?',
   answer: 'Yes, combining Mounjaro 12.5mg with a balanced diet and regular exercise further enhances its benefits.'
 },
