    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          <h2 className="text-3xl font-medium mb-6">Fexofenadine 180mg          </h2>
          <p className="text-gray-200 text-lg leading-relaxed">
         
          Fexofenadine 180mg is a non drowsy antihistamine that relieves hayfever symptoms like sneezing, runny nose, and itching, offering fast, effective relief.
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Fexofenadine 180mg is a powerful once daily antihistamine that provides up to 24 hours of relief from troublesome hayfever symptoms such as sneezing, runny nose, itchy eyes, and throat irritation. Thanks to its non drowsy formula, it helps you stay alert and comfortable throughout the day. By blocking the effects of histamine, Fexofenadine minimises allergic reactions and supports a better quality of life during the peak allergy season. Always follow your doctor&apos;s advice or the instructions on the pack to ensure proper dosing. If symptoms persist or worsen, consult a healthcare professional for further guidance.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'What is Fexofenadine 180mg used for?',
     answer: 'It is primarily used to manage hayfever symptoms by reducing sneezing, runny nose, and itching.'
   },
   {
    id: 2,
    question: 'How soon does it start working?',
    answer: 'Relief can begin within one to three hours, though individual responses may vary.'
  },
  {
   id: 3,
   question: 'Is Fexofenadine suitable for daily use?',
   answer: 'Yes it can be taken daily during allergy seasons or as advised by a healthcare professional.'
 },
 {
   id: 4,
   question: 'Are there any side effects?',
   answer: 'Possible side effects include headache or mild dizziness. Speak to your doctor if you experience any concerning symptoms.'
 },
 {
   id: 5,
   question: 'Can I take Fexofenadine with other medications?',
   answer: 'Always inform your doctor or pharmacist about any other medicines or supplements you are taking to avoid interactions.'
 },
 {
   id: 6,
   question: 'Is it really non drowsy?',
   answer: 'Many people find it does not cause drowsiness but reactions vary. If you feel drowsy do not drive or operate machinery.'
 },
 {
   id: 7,
   question: 'When should I see a doctor?',
   answer: 'If your symptoms persist despite regular use or you experience severe reactions seek medical advice.'
 },
