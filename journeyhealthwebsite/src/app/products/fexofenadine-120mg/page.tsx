    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 my-8">
        ...
        <div className="w-full md:w-1/2 bg-slate-800 bg-gradient-to-br from-slate-700 to-slate-900 text-white p-10 rounded-2xl shadow-md">
          <h2 className="text-3xl font-medium mb-6">Fexofenadine 120mg         </h2>
          <p className="text-gray-200 text-lg leading-relaxed">
         
          Fexofenadine 120mg is a fast acting non drowsy antihistamine that offers 24 hour relief from troublesome hayfever symptoms including sneezing itching and runny nose.
          </p>
        </div>
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-10 rounded-2xl shadow-sm border border-gray-100">
          ...
          Fexofenadine 120mg is formulated to target hayfever symptoms like sneezing congestion runny nose and itchy eyes offering up to 24 hours of relief in a once daily dose. Because it is less likely to cause drowsiness Fexofenadine helps you maintain normal day to day activities without feeling sluggish. It works by blocking the effects of histamine a chemical released by the body during allergic reactions. Always follow the dosage guidelines provided by your doctor or pharmacist to ensure safe and effective use. If symptoms persist or worsen seek professional advice for further evaluation and management.
...
const FAQSection = () => {
 ...
 const faqItems = [
   {
     id: 1,
     question: 'How does Fexofenadine 120mg work?',
     answer: 'It blocks the action of histamine the substance in your body responsible for allergic symptoms like sneezing and itching.'
   },
   {
    id: 2,
    question: 'When should I take it?',
    answer: 'Usually once a day as recommended by your healthcare professional. Taking it at the same time each day can support consistent symptom relief.'
  },
  {
   id: 3,
   question: 'Can I drive or operate machinery?',
   answer: 'Many people do not feel drowsy but if you experience any sleepiness or dizziness avoid driving or using heavy machinery.'
 },
 {
   id: 4,
   question: 'Is it suitable for children?',
   answer: 'Fexofenadine 120mg is generally for adults and children over a certain age. Check the patient leaflet or ask your doctor for specific age recommendations.'
 },
 {
   id: 5,
   question: 'Are there any side effects?',
   answer: 'Possible side effects include headache nausea or dry mouth. Contact a healthcare professional if any side effects become severe.'
 },
 {
   id: 6,
   question: 'Can I take other medicines while using Fexofenadine 120mg?',
   answer: 'Always inform your doctor or pharmacist of any other medications or supplements to avoid interactions.'
 },
 {
   id: 7,
   question: 'What if symptoms do not improve?',
   answer: 'If hayfever symptoms persist or worsen despite taking Fexofenadine seek further medical advice to explore alternative treatments.'
 },
